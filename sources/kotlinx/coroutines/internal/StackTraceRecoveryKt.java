...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            str = Result.m699constructorimpl(cls.getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m699constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m701exceptionOrNullimpl(str) == null) {
            str2 = str;
        }
        ...
        try {
            ...
            obj = Result.m699constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th2) {
    ...
    private static final <E extends Throwable> E createFinalException(E e, E e2, ArrayDeque<StackTraceElement> arrayDeque) {
        ...
        while (it.hasNext()) {
            stackTraceElementArr[frameIndex + i] = it.next();
            i++;
        }
