...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
                ...
                if (!getChannel().enqueueReceive(receiveHasNext)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuationImpl.resumeWith(Result.m699constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuationImpl.resumeWith(Result.m699constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuationImpl.resumeWith(Result.m699constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    private final boolean enqueueReceive(kotlinx.coroutines.channels.Receive<? super E> r8) {
        /*
            r7 = this;
