        ...
        try {
            ...
            try {
                ...
                if (invoke != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m699constructorimpl(invoke));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(context, updateThreadContext);
                throw th;
            ...
            probeCoroutineCreated.resumeWith(Result.m699constructorimpl(ResultKt.createFailure(th2)));
        }
    }
