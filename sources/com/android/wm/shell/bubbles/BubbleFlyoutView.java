...
public class BubbleFlyoutView extends FrameLayout {
    ...
    public BubbleFlyoutView(Context context) {
        ...
        setOutlineProvider(new ViewOutlineProvider() {
            /* class com.android.wm.shell.bubbles.BubbleFlyoutView.AnonymousClass1 */
    ...
    public void updateFontSize() {
        float dimensionPixelSize = (float) ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(17105543);
    ...
    private /* synthetic */ void lambda$animateUpdate$2(Bubble.FlyoutMessage flyoutMessage, float f, PointF pointF, boolean z) {
        updateFlyoutMessage(flyoutMessage, f);
        post(new BubbleFlyoutView$$ExternalSyntheticLambda0(this, pointF, z));
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateUpdate$1(PointF pointF, boolean z) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupFlyoutStartingAsDot$3(PointF pointF, boolean z, Runnable runnable) {
