...
public class ExpandedAnimationController extends PhysicsAnimationLayout.PhysicsAnimationController {
    ...
    /* renamed from: $r8$lambda$GKcras8sS-gXfv-J9BCmeWKVCtM  reason: not valid java name */
    public static /* synthetic */ void m525$r8$lambda$GKcras8sSgXfvJ9BCmeWKVCtM(ExpandedAnimationController expandedAnimationController, boolean z, int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
        expandedAnimationController.lambda$startOrUpdatePathAnimation$3(z, i, physicsPropertyAnimator);
    }

    /* renamed from: $r8$lambda$UgrATDb6jy9HXrp-60oaJpzK8DM  reason: not valid java name */
    public static /* synthetic */ void m527$r8$lambda$UgrATDb6jy9HXrp60oaJpzK8DM(View view) {
        view.setTranslationZ(0.0f);
    }

    /* renamed from: $r8$lambda$n7KjySQ-Y90wiVvZj-qLYIvD0yA  reason: not valid java name */
    public static /* synthetic */ void m528$r8$lambda$n7KjySQY90wiVvZjqLYIvD0yA(int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
        lambda$onActiveControllerForLayout$6(i, physicsPropertyAnimator);
    }
    ...
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$0() {
        this.mAnimatingExpand = false;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$1() {
        this.mAnimatingCollapse = false;
    ...
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$3(boolean z, int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
        float f;
        int i2;
        float f2;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$2() {
    ...
    public void prepareForBubbleDrag(final View view, MagnetizedObject.MagneticTarget magneticTarget, MagnetizedObject.MagnetListener magnetListener) {
        ...
        AnonymousClass1 r0 = new MagnetizedObject<View>(this.mLayout.getContext(), DynamicAnimation.TRANSLATION_X, DynamicAnimation.TRANSLATION_Y, view) {
            /* class com.android.wm.shell.bubbles.animation.ExpandedAnimationController.AnonymousClass1 */
    ...
    private static /* synthetic */ void lambda$onActiveControllerForLayout$6(int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
