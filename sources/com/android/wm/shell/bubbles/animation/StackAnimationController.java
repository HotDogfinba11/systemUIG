...
public class StackAnimationController extends PhysicsAnimationLayout.PhysicsAnimationController {
    ...
    private final FloatingContentCoordinator.FloatingContent mStackFloatingContent = new FloatingContentCoordinator.FloatingContent() {
        /* class com.android.wm.shell.bubbles.animation.StackAnimationController.AnonymousClass1 */
    ...
    public void flingThenSpringFirstBubbleWithStackFollowing(DynamicAnimation.ViewProperty viewProperty, float f, float f2, SpringForce springForce, Float f3) {
        ...
        if (isActiveController()) {
            ...
            flingAnimation.setFriction(f2).setStartVelocity(f).setMinValue(Math.min(value, f4)).setMaxValue(Math.max(value, f5)).addEndListener(new StackAnimationController$$ExternalSyntheticLambda0(this, viewProperty, springForce, f3, f4, f5));
    ...
    private /* synthetic */ void lambda$flingThenSpringFirstBubbleWithStackFollowing$0(DynamicAnimation.ViewProperty viewProperty, SpringForce springForce, Float f, float f2, float f3, DynamicAnimation dynamicAnimation, boolean z, float f4, float f5) {
        float f6;
        if (!z) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateStackDismissal$1(float f, int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$springFirstBubbleWithStackFollowing$2(boolean z, Runnable[] runnableArr, DynamicAnimation dynamicAnimation, boolean z2, float f, float f2) {
        if (!z) {
            this.mPositioner.setRestingPosition(this.mStackPosition);
        }
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateReorder$3(List list) {
        for (int i = 0; i < list.size(); i++) {
    ...
    private void animateToFrontThenUpdateIcons(View view, Runnable runnable, Runnable runnable2) {
        view.setTag(R.id.reorder_animator_tag, view.animate().translationY(getStackPosition().y - this.mSwapAnimationOffset).setDuration(300).withEndAction(new StackAnimationController$$ExternalSyntheticLambda6(this, runnable, view, runnable2)));
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateToFrontThenUpdateIcons$4(Runnable runnable, View view, Runnable runnable2) {
        runnable.run();
        moveToFinalIndex(view, 0, runnable2);
    }

    private void moveToFinalIndex(View view, int i, Runnable runnable) {
        view.setTag(R.id.reorder_animator_tag, view.animate().translationY(getStackPosition().y + (((float) Math.min(i, 1)) * this.mStackOffset)).setDuration(300).withEndAction(new StackAnimationController$$ExternalSyntheticLambda4(view, runnable)));
    }
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$moveStackToStartPosition$6() {
    ...
    public MagnetizedObject<StackAnimationController> getMagnetizedStack() {
        if (this.mMagnetizedStack == null) {
            AnonymousClass2 r0 = new MagnetizedObject<StackAnimationController>(this.mLayout.getContext(), this, new StackPositionProperty(DynamicAnimation.TRANSLATION_X), new StackPositionProperty(DynamicAnimation.TRANSLATION_Y)) {
                /* class com.android.wm.shell.bubbles.animation.StackAnimationController.AnonymousClass2 */
    ...
    public class StackPositionProperty extends FloatPropertyCompat<StackAnimationController> {
        ...
        private StackPositionProperty(DynamicAnimation.ViewProperty viewProperty) {
            ...
            StackAnimationController.this = r1;
