...
public final class BubbleOverflow implements BubbleViewProvider {
    ...
    private final void updateBtnTheme() {
        ...
        Bitmap bitmap2 = bubbleIconFactory.createBadgedIconBitmap(new AdaptiveIconDrawable(new ColorDrawable(color), new InsetDrawable(badgedImageView2 == null ? null : badgedImageView2.getDrawable(), this.overflowIconInset)), null, true).icon;
