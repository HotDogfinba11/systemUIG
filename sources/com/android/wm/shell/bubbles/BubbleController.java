...
public class BubbleController {
    ...
    private final BubbleData.Listener mBubbleDataListener = new BubbleData.Listener() {
        /* class com.android.wm.shell.bubbles.BubbleController.AnonymousClass4 */
    ...
    public void initialize() {
        ...
        this.mLauncherApps.registerCallback(new LauncherApps.Callback() {
            /* class com.android.wm.shell.bubbles.BubbleController.AnonymousClass1 */
        ...
        this.mTaskStackListener.addListener(new TaskStackListenerCallback() {
            /* class com.android.wm.shell.bubbles.BubbleController.AnonymousClass2 */
        ...
        this.mDisplayController.addDisplayChangingController(new DisplayChangeController.OnDisplayChangingListener() {
            /* class com.android.wm.shell.bubbles.BubbleController.AnonymousClass3 */
    ...
    private void onTaskbarChanged(Bundle bundle) {
        boolean z;
        if (bundle != null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStatusBarStateChanged(boolean z) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setBubbleScrim(View view, BiConsumer<Executor, Looper> biConsumer) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeSuppressedSummaryIfNecessary(String str, Consumer<String> consumer) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onEntryUpdated(BubbleEntry bubbleEntry, boolean z) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onRankingUpdated(NotificationListenerService.RankingMap rankingMap, HashMap<String, Pair<BubbleEntry, Boolean>> hashMap) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean handleDismissalInterception(BubbleEntry bubbleEntry, List<BubbleEntry> list, IntConsumer intConsumer) {
        if (isSummaryOfBubbles(bubbleEntry)) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
