...
public class BadgedImageView extends ImageView {
    ...
    public BadgedImageView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setOutlineProvider(new ViewOutlineProvider() {
            /* class com.android.wm.shell.bubbles.BadgedImageView.AnonymousClass1 */
    ...
    private /* synthetic */ void lambda$animateDotBadgePositions$0() {
        invalidate();
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateDotScale$1(boolean z, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$animateDotScale$2(boolean z, Runnable runnable) {
