...
public final class BubblePersistentRepository {
    ...
    public final android.util.SparseArray<java.util.List<com.android.wm.shell.bubbles.storage.BubbleEntity>> readFromDisk() {
        ...
        L_0x0012:
            ...
            r1 = 0
            android.util.SparseArray r2 = com.android.wm.shell.bubbles.storage.BubbleXmlHelperKt.readXml(r3)     // Catch:{ all -> 0x0022 }
            kotlin.io.CloseableKt.closeFinally(r3, r1)
            monitor-exit(r0)
            return r2
        L_0x0022:
        ...
        L_0x0038:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.wm.shell.bubbles.storage.BubblePersistentRepository.readFromDisk():android.util.SparseArray");
    }
}
