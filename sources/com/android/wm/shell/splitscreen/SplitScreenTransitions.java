...
public class SplitScreenTransitions {
    ...
    public static /* synthetic */ void $r8$lambda$zBJz70Jb7fWfoaH7HWz3ujB1fA0(SplitScreenTransitions splitScreenTransitions, SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, float f, ValueAnimator valueAnimator) {
        splitScreenTransitions.lambda$startExampleAnimation$3(transaction, surfaceControl, f, valueAnimator);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$new$0(WindowContainerTransaction windowContainerTransaction, WindowContainerTransactionCallback windowContainerTransactionCallback) {
    ...
    private void startExampleAnimation(SurfaceControl surfaceControl, boolean z) {
        ...
        ofFloat.addListener(new Animator.AnimatorListener() {
            /* class com.android.wm.shell.splitscreen.SplitScreenTransitions.AnonymousClass1 */
    ...
    private /* synthetic */ void lambda$startExampleAnimation$3(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, float f, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startExampleAnimation$2(ValueAnimator valueAnimator) {
    ...
    private void startExampleResizeAnimation(SurfaceControl surfaceControl, Rect rect, Rect rect2) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.android.wm.shell.splitscreen.SplitScreenTransitions.AnonymousClass2 */
    ...
    private /* synthetic */ void lambda$startExampleResizeAnimation$6(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, Rect rect, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startExampleResizeAnimation$5(ValueAnimator valueAnimator) {
        this.mAnimations.remove(valueAnimator);
        onFinish();
    }
}
