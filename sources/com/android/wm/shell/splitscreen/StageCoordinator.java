...
public class StageCoordinator implements SplitLayout.SplitLayoutHandler, RootTaskDisplayAreaOrganizer.RootTaskDisplayAreaListener, Transitions.TransitionHandler {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStageChildTaskStatusChanged(StageListenerImpl stageListenerImpl, int i, boolean z, boolean z2) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStageRootTaskAppeared(StageListenerImpl stageListenerImpl) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStageRootTaskVanished(StageListenerImpl stageListenerImpl) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStageVisibilityChanged(StageListenerImpl stageListenerImpl) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onStageVisibilityChanged$1(boolean z, boolean z2, SurfaceControl.Transaction transaction) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onStageHasChildrenChanged(StageListenerImpl stageListenerImpl) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onDisplayAreaAppeared$4(SurfaceControl.Builder builder) {
        ...
        if (triggerTask != null) {
            ...
            if (isSplitScreenVisible()) {
                if (ShellProtoLogCache.WM_SHELL_TRANSITIONS_enabled) {
                    ...
                    ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TRANSITIONS, 165317020, 81, "  split is active so using splitTransition to handle request. triggerTask=%d type=%s mainChildren=%d sideChildren=%d", Long.valueOf(j), String.valueOf(WindowManager.transitTypeToString(type)), Long.valueOf((long) this.mMainStage.getChildCount()), Long.valueOf((long) this.mSideStage.getChildCount()));
                }
