...
public class SplitScreenController implements DragAndDropPolicy.Starter, RemoteCallable<SplitScreenController> {
    ...
    public static class ISplitScreenImpl extends ISplitScreen.Stub {
        ...
        private final IBinder.DeathRecipient mListenerDeathRecipient = new IBinder.DeathRecipient() {
            /* class com.android.wm.shell.splitscreen.SplitScreenController.ISplitScreenImpl.AnonymousClass2 */
        ...
        private final SplitScreen.SplitScreenListener mSplitScreenListener = new SplitScreen.SplitScreenListener() {
            /* class com.android.wm.shell.splitscreen.SplitScreenController.ISplitScreenImpl.AnonymousClass1 */
