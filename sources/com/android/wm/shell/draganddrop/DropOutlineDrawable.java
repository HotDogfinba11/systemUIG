...
public class DropOutlineDrawable extends Drawable {
    ...
    private final Property<DropOutlineDrawable, Rect> BOUNDS = new Property<DropOutlineDrawable, Rect>(Rect.class, "bounds") {
        /* class com.android.wm.shell.draganddrop.DropOutlineDrawable.AnonymousClass2 */
    ...
    public DropOutlineDrawable(Context context) {
        AnonymousClass1 r0 = new IntProperty<DropOutlineDrawable>("alpha") {
            /* class com.android.wm.shell.draganddrop.DropOutlineDrawable.AnonymousClass1 */
    ...
    public ObjectAnimator startBoundsAnimation(Rect rect, Interpolator interpolator) {
        if (ShellProtoLogCache.WM_SHELL_DRAG_AND_DROP_enabled) {
            ...
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_DRAG_AND_DROP, -1000962629, 0, null, valueOf, valueOf2);
        }
        ObjectAnimator objectAnimator = this.mBoundsAnimator;
        if (objectAnimator != null) {
            objectAnimator.cancel();
        }
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this, this.BOUNDS, this.mRectEvaluator, this.mBounds, rect);
