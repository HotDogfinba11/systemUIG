...
public class RemoteTransitionHandler implements Transitions.TransitionHandler {
    ...
    private final IBinder.DeathRecipient mTransitionDeathRecipient = new IBinder.DeathRecipient() {
        /* class com.android.wm.shell.transition.RemoteTransitionHandler.AnonymousClass1 */
    ...
    public boolean startAnimation(final IBinder iBinder, TransitionInfo transitionInfo, SurfaceControl.Transaction transaction, final Transitions.TransitionFinishCallback transitionFinishCallback) {
        ...
        final RemoteTransitionHandler$$ExternalSyntheticLambda0 remoteTransitionHandler$$ExternalSyntheticLambda0 = new RemoteTransitionHandler$$ExternalSyntheticLambda0(this, iBinder, transitionFinishCallback);
        AnonymousClass2 r4 = new IRemoteTransitionFinishedCallback.Stub() {
            /* class com.android.wm.shell.transition.RemoteTransitionHandler.AnonymousClass2 */
            ...
            /* access modifiers changed from: public */
            private /* synthetic */ void lambda$onTransitionFinished$0(IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback, WindowContainerTransaction windowContainerTransaction) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startAnimation$1(IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startAnimation$0(IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback) {
        this.mRequestedRemotes.remove(iBinder);
        ...
        if (iRemoteTransition != null) {
            try {
                iRemoteTransition.mergeAnimation(iBinder, transitionInfo, transaction, iBinder2, new IRemoteTransitionFinishedCallback.Stub() {
                    /* class com.android.wm.shell.transition.RemoteTransitionHandler.AnonymousClass3 */
