...
public class DefaultTransitionHandler implements Transitions.TransitionHandler {
    ...
    public static /* synthetic */ void $r8$lambda$hbnbo3kcmXWANUSgiRavnHDFX0E(ArrayList arrayList, ValueAnimator valueAnimator, Runnable runnable) {
        lambda$startAnimInternal$2(arrayList, valueAnimator, runnable);
    }
    ...
    private /* synthetic */ void lambda$startAnimation$0(ArrayList arrayList, IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback) {
    ...
    private void startAnimInternal(ArrayList<Animator> arrayList, Animation animation, SurfaceControl surfaceControl, Runnable runnable) {
        ...
        ofFloat.addUpdateListener(new DefaultTransitionHandler$$ExternalSyntheticLambda0(ofFloat, acquire, surfaceControl, animation, transformation, fArr));
        final DefaultTransitionHandler$$ExternalSyntheticLambda1 defaultTransitionHandler$$ExternalSyntheticLambda1 = new DefaultTransitionHandler$$ExternalSyntheticLambda1(this, ofFloat, acquire, surfaceControl, animation, transformation, fArr, arrayList, runnable);
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.android.wm.shell.transition.DefaultTransitionHandler.AnonymousClass1 */
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startAnimInternal$3(ValueAnimator valueAnimator, SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, Animation animation, Transformation transformation, float[] fArr, ArrayList arrayList, Runnable runnable) {
    ...
    private static /* synthetic */ void lambda$startAnimInternal$2(ArrayList arrayList, ValueAnimator valueAnimator, Runnable runnable) {
