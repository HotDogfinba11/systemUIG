...
public class PipResizeGestureHandler {
    ...
    public void init() {
        ...
        DeviceConfig.addOnPropertiesChangedListener("systemui", this.mMainExecutor, new DeviceConfig.OnPropertiesChangedListener() {
            /* class com.android.wm.shell.pip.phone.PipResizeGestureHandler.AnonymousClass1 */
    ...
    private /* synthetic */ void lambda$updateIsEnabled$0() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$finishResize$1(Rect rect) {
