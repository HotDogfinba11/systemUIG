...
public class PipTouchHandler {
    ...
    public PipTouchHandler(Context context, PhonePipMenuController phonePipMenuController, PipBoundsAlgorithm pipBoundsAlgorithm, PipBoundsState pipBoundsState, PipTaskOrganizer pipTaskOrganizer, PipMotionHelper pipMotionHelper, FloatingContentCoordinator floatingContentCoordinator, PipUiEventLogger pipUiEventLogger, ShellExecutor shellExecutor) {
        ...
        this.mPipResizeGestureHandler = new PipResizeGestureHandler(context, pipBoundsAlgorithm, pipBoundsState, this.mMotionHelper, pipTaskOrganizer, pipDismissTargetHandler, new PipTouchHandler$$ExternalSyntheticLambda7(this), new PipTouchHandler$$ExternalSyntheticLambda5(this), pipUiEventLogger, phonePipMenuController, shellExecutor);
        ...
        this.mTouchState = new PipTouchState(viewConfiguration, pipTouchHandler$$ExternalSyntheticLambda4, new PipTouchHandler$$ExternalSyntheticLambda3(phonePipMenuController), shellExecutor);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onPipMenuStateChangeStart(int i, boolean z, Runnable runnable) {
        int rotation;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void animateToMaximizedState(Runnable runnable) {
        Rect rect = new Rect();
        int i = 0;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void animateToUnexpandedState(Rect rect) {
        Rect rect2 = new Rect();
