...
public class PipMediaController {
    ...
    private final MediaController.Callback mPlaybackChangedListener = new MediaController.Callback() {
        /* class com.android.wm.shell.pip.PipMediaController.AnonymousClass2 */
    ...
    public PipMediaController(Context context, Handler handler) {
        AnonymousClass1 r0 = new BroadcastReceiver() {
            /* class com.android.wm.shell.pip.PipMediaController.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void notifyMetadataChanged(MediaMetadata mediaMetadata) {
