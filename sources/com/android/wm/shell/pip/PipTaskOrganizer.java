...
public class PipTaskOrganizer implements ShellTaskOrganizer.TaskListener, DisplayController.OnDisplaysChangedListener {
    ...
    private final PipAnimationController.PipAnimationCallback mPipAnimationCallback = new PipAnimationController.PipAnimationCallback() {
        /* class com.android.wm.shell.pip.PipTaskOrganizer.AnonymousClass1 */
    ...
    private final PipAnimationController.PipTransactionHandler mPipTransactionHandler = new PipAnimationController.PipTransactionHandler() {
        /* class com.android.wm.shell.pip.PipTaskOrganizer.AnonymousClass2 */
    ...
    public void enterPipWithAlphaAnimation(Rect rect, long j) {
        ...
        applyEnterPipSyncTransaction(rect, new PipTaskOrganizer$$ExternalSyntheticLambda7(this, rect, j), null);
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void fadeOutAndRemoveOverlay(final SurfaceControl surfaceControl, final Runnable runnable, boolean z) {
        if (surfaceControl != null) {
            ...
            ofFloat.addListener(new AnimatorListenerAdapter() {
                /* class com.android.wm.shell.pip.PipTaskOrganizer.AnonymousClass3 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeContentOverlay(SurfaceControl surfaceControl, Runnable runnable) {
        if (this.mState != State.UNDEFINED) {
            SurfaceControl.Transaction transaction = this.mSurfaceControlTransactionFactory.getTransaction();
