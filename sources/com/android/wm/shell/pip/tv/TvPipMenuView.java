...
public class TvPipMenuView extends FrameLayout implements View.OnClickListener {
    ...
    /* renamed from: $r8$lambda$vH-gp_0eEazrv0kUlIjEN6xSVSM  reason: not valid java name */
    public static /* synthetic */ void m604$r8$lambda$vHgp_0eEazrv0kUlIjEN6xSVSM(TvPipMenuActionButton tvPipMenuActionButton, Drawable drawable) {
        lambda$setAdditionalActions$0(tvPipMenuActionButton, drawable);
    }
    ...
    public void setAdditionalActions(List<RemoteAction> list, Handler handler) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            remoteAction.getIcon().loadDrawableAsync(((FrameLayout) this).mContext, new TvPipMenuView$$ExternalSyntheticLambda0(tvPipMenuActionButton3), handler);
        }
    }

    private static /* synthetic */ void lambda$setAdditionalActions$0(TvPipMenuActionButton tvPipMenuActionButton, Drawable drawable) {
        drawable.setTint(-1);
