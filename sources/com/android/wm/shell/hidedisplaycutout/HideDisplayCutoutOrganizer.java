...
public class HideDisplayCutoutOrganizer extends DisplayAreaOrganizer {
    ...
    private final DisplayController.OnDisplaysChangedListener mListener = new DisplayController.OnDisplaysChangedListener() {
        /* class com.android.wm.shell.hidedisplaycutout.HideDisplayCutoutOrganizer.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void applyAllBoundsAndOffsets(WindowContainerTransaction windowContainerTransaction, SurfaceControl.Transaction transaction) {
        synchronized (this) {
