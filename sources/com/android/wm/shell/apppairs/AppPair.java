...
public class AppPair implements ShellTaskOrganizer.TaskListener, SplitLayout.SplitLayoutHandler {
    ...
    public static /* synthetic */ void $r8$lambda$SLjql9mcd45mM1yMfVDW955V9Dg(AppPair appPair, SurfaceControl.Builder builder) {
        appPair.lambda$pair$0(builder);
    }
    ...
    public boolean pair(ActivityManager.RunningTaskInfo runningTaskInfo, ActivityManager.RunningTaskInfo runningTaskInfo2) {
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ...
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -742394458, 5, null, Long.valueOf(j), Long.valueOf(j2), valueOf);
        }
        boolean z = runningTaskInfo.supportsMultiWindow;
        if (!z || !runningTaskInfo2.supportsMultiWindow) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                boolean z2 = runningTaskInfo2.supportsMultiWindow;
                ShellProtoLogImpl.e(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -553798917, 15, null, Boolean.valueOf(z), Boolean.valueOf(z2));
            }
            return false;
        }
    ...
    private /* synthetic */ void lambda$pair$0(SurfaceControl.Builder builder) {
    ...
    private /* synthetic */ void lambda$onTaskAppeared$1(SurfaceControl.Transaction transaction) {
        this.mDimLayer1 = SurfaceUtils.makeDimLayer(transaction, this.mTaskLeash1, "Dim layer", this.mSurfaceSession);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onTaskAppeared$2(SurfaceControl.Transaction transaction) {
        this.mDimLayer2 = SurfaceUtils.makeDimLayer(transaction, this.mTaskLeash2, "Dim layer", this.mSurfaceSession);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onTaskAppeared$3(SurfaceControl surfaceControl, Rect rect, SurfaceControl.Transaction transaction) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onTaskInfoChanged$4(ActivityManager.RunningTaskInfo runningTaskInfo, SurfaceControl.Transaction transaction) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onTaskVanished$5(SurfaceControl.Transaction transaction) {
        transaction.remove(this.mDimLayer1);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onTaskVanished$6(SurfaceControl.Transaction transaction) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onBoundsChanging$7(SplitLayout splitLayout, SurfaceControl.Transaction transaction) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onBoundsChanged$8(SplitLayout splitLayout, SurfaceControl.Transaction transaction) {
        splitLayout.applySurfaceChanges(transaction, this.mTaskLeash1, this.mTaskLeash2, this.mDimLayer1, this.mDimLayer2);
    }
}
