...
public class AppPairsPool {
    ...
    public AppPair acquire() {
        ...
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ...
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 2006473416, 16, null, valueOf, valueOf2, Long.valueOf((long) this.mPool.size()));
        }
    ...
    public void release(AppPair appPair) {
        ...
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ...
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 1891981945, 16, null, valueOf, valueOf2, Long.valueOf(size));
        }
    }
    ...
    public void incrementPool() {
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            long size = (long) this.mPool.size();
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 1079041527, 1, null, Long.valueOf(size));
        }
