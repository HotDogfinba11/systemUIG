...
public class OneHandedDisplayAreaOrganizer extends DisplayAreaOrganizer {
    ...
    OneHandedAnimationCallback mOneHandedAnimationCallback = new OneHandedAnimationCallback() {
        /* class com.android.wm.shell.onehanded.OneHandedDisplayAreaOrganizer.AnonymousClass1 */
    ...
    private /* synthetic */ void lambda$scheduleOffset$0(float f, int i, int i2, WindowContainerToken windowContainerToken, SurfaceControl surfaceControl) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$resetWindowsOffset$1(SurfaceControl.Transaction transaction, WindowContainerToken windowContainerToken, SurfaceControl surfaceControl) {
