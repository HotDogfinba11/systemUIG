...
public final class FloatingContentCoordinator$Companion$findAreaForContentVertically$positionAboveInBounds$2 extends Lambda implements Function0<Boolean> {
    ...
    FloatingContentCoordinator$Companion$findAreaForContentVertically$positionAboveInBounds$2(Rect rect, Lazy<Rect> lazy) {
        super(0);
    ...
    public final Boolean invoke() {
        return this.$allowedBounds.contains(FloatingContentCoordinator.Companion.m547findAreaForContentVertically$lambda2(this.$newContentBoundsAbove$delegate));
    }
}
