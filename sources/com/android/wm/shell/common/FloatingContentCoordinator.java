...
public final class FloatingContentCoordinator {
    ...
    public static final class Companion {
        ...
        public final Rect findAreaForContentVertically(Rect rect, Rect rect2, Collection<Rect> collection, Rect rect3) {
            ...
            if ((!z2 || !m550findAreaForContentVertically$lambda5(lazy4)) && (z2 || m549findAreaForContentVertically$lambda4(lazy3))) {
                z = false;
            }
            Rect r7 = z ? m548findAreaForContentVertically$lambda3(lazy2) : m547findAreaForContentVertically$lambda2(lazy);
            return rect3.contains(r7) ? r7 : new Rect();
        }

        /* access modifiers changed from: private */
        /* renamed from: findAreaForContentVertically$lambda-2  reason: not valid java name */
        public static final Rect m547findAreaForContentVertically$lambda2(Lazy<Rect> lazy) {
            return lazy.getValue();
        }

        /* access modifiers changed from: private */
        /* renamed from: findAreaForContentVertically$lambda-3  reason: not valid java name */
        public static final Rect m548findAreaForContentVertically$lambda3(Lazy<Rect> lazy) {
            return lazy.getValue();
        }

        /* renamed from: findAreaForContentVertically$lambda-4  reason: not valid java name */
        private static final boolean m549findAreaForContentVertically$lambda4(Lazy<Boolean> lazy) {
            return lazy.getValue().booleanValue();
        }

        /* renamed from: findAreaForContentVertically$lambda-5  reason: not valid java name */
        private static final boolean m550findAreaForContentVertically$lambda5(Lazy<Boolean> lazy) {
            return lazy.getValue().booleanValue();
        }
