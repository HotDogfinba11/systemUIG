...
public final class SplitLayout {
    ...
    private void flingDividePosition(int i, final int i2) {
        if (i != i2) {
            ...
            duration.addListener(new AnimatorListenerAdapter() {
                /* class com.android.wm.shell.common.split.SplitLayout.AnonymousClass1 */
    ...
    public class ImePositionProcessor implements DisplayImeController.ImePositionProcessor {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private Rect adjustForIme(Rect rect) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void applySurfaceDimValues(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, SurfaceControl surfaceControl2) {
            boolean z = true;
