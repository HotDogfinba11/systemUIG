...
public class DisplayController {
    ...
    private void onDisplayAdded(int i) {
        Context context;
        synchronized (this.mDisplays) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onDisplayConfigurationChanged(int i, Configuration configuration) {
        synchronized (this.mDisplays) {
            DisplayRecord displayRecord = this.mDisplays.get(i);
            if (displayRecord == null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onDisplayRemoved(int i) {
        synchronized (this.mDisplays) {
            if (this.mDisplays.get(i) != null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onFixedRotationStarted(int i, int i2) {
        synchronized (this.mDisplays) {
            if (this.mDisplays.get(i) != null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onFixedRotationFinished(int i) {
        synchronized (this.mDisplays) {
            if (this.mDisplays.get(i) != null) {
                if (getDisplay(i) != null) {
                    for (int size = this.mDisplayChangedListeners.size() - 1; size >= 0; size--) {
