...
public class SplashscreenContentDrawer {
    ...
    private static void getWindowAttrs(Context context, SplashScreenWindowAttrs splashScreenWindowAttrs) {
        ...
        splashScreenWindowAttrs.mWindowBgColor = ((Integer) safeReturnAttrDefault(new SplashscreenContentDrawer$$ExternalSyntheticLambda6(obtainStyledAttributes), 0)).intValue();
        splashScreenWindowAttrs.mSplashScreenIcon = (Drawable) safeReturnAttrDefault(new SplashscreenContentDrawer$$ExternalSyntheticLambda3(obtainStyledAttributes), null);
        splashScreenWindowAttrs.mAnimationDuration = ((Integer) safeReturnAttrDefault(new SplashscreenContentDrawer$$ExternalSyntheticLambda7(obtainStyledAttributes), 0)).intValue();
        splashScreenWindowAttrs.mBrandingImage = (Drawable) safeReturnAttrDefault(new SplashscreenContentDrawer$$ExternalSyntheticLambda4(obtainStyledAttributes), null);
        ...
        private SplashScreenView fillViewWithIcon(int i, Drawable[] drawableArr, int i2) {
            ...
            if (this.mSuggestType != 4) {
                build.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                    /* class com.android.wm.shell.startingsurface.SplashscreenContentDrawer.StartingWindowViewBuilder.AnonymousClass1 */
