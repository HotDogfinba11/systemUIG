...
public class TaskSnapshotWindow {
    ...
    static TaskSnapshotWindow create(StartingWindowInfo startingWindowInfo, IBinder iBinder, TaskSnapshot taskSnapshot, ShellExecutor shellExecutor, Runnable runnable) {
        ...
        TaskSnapshotWindow taskSnapshotWindow = new TaskSnapshotWindow(surfaceControl, taskSnapshot, layoutParams3.getTitle(), taskDescription, i2, i3, i4, rect, orientation, i5, taskSnapshot.hasImeSurface() ? 600 : 100, insetsState, runnable, shellExecutor);
    ...
    /* access modifiers changed from: package-private */
    public void scheduleRemove(Runnable runnable) {
        ...
        TaskSnapshotWindow$$ExternalSyntheticLambda0 taskSnapshotWindow$$ExternalSyntheticLambda0 = new TaskSnapshotWindow$$ExternalSyntheticLambda0(this, runnable);
        this.mScheduledRunnable = taskSnapshotWindow$$ExternalSyntheticLambda0;
        this.mSplashScreenExecutor.executeDelayed(taskSnapshotWindow$$ExternalSyntheticLambda0, this.mDelayRemovalTime);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$scheduleRemove$0(Runnable runnable) {
        removeImmediately();
        runnable.run();
    }
    ...
    public static class Window extends BaseIWindow {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$resized$0(MergedConfiguration mergedConfiguration, boolean z) {
