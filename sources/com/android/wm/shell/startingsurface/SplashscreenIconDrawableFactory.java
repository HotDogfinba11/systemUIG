...
public class SplashscreenIconDrawableFactory {
    ...
    public static class AnimatableIconAnimateListener extends AdaptiveForegroundDrawable implements SplashScreenView.IconAnimateListener {
        ...
        AnimatableIconAnimateListener(Drawable drawable) {
            super(drawable);
            AnonymousClass2 r1 = new Drawable.Callback() {
                /* class com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory.AnimatableIconAnimateListener.AnonymousClass2 */
        ...
        public boolean prepareAnimate(long j, final Runnable runnable) {
            ...
            this.mIconAnimator.addListener(new Animator.AnimatorListener() {
                /* class com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory.AnimatableIconAnimateListener.AnonymousClass1 */
        ...
        @Override // com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory.AdaptiveForegroundDrawable, com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory.MaskBackgroundDrawable
        public void draw(Canvas canvas) {
