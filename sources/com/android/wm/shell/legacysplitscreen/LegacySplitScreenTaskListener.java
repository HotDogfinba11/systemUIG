        ...
        synchronized (this) {
            ...
            if (windowingMode == 3) {
                if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                    ...
                    ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -1362429294, 4, null, valueOf, Long.valueOf(j));
                }
                ...
                if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                    ...
                    long j2 = (long) runningTaskInfo.taskId;
                    ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 982027396, 4, null, valueOf2, Long.valueOf(j2));
                }
                ...
                long j3 = (long) runningTaskInfo.taskId;
                ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -298656957, 20, null, valueOf3, Long.valueOf(j3), Long.valueOf((long) windowingMode));
            }
            if (!(this.mSplitScreenSupported || this.mPrimarySurface == null || this.mSecondarySurface == null)) {
                ...
                if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                    ...
                    ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 473543554, 0, null, valueOf4);
                }
            ...
            synchronized (this) {
                if (!runningTaskInfo.supportsMultiWindow) {
                    if (this.mSplitScreenController.isDividerVisible()) {
                        ...
                        if (i != i2) {
                            if (runningTaskInfo.parentTaskId != i2) {
