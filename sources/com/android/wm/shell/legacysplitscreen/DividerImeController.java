...
public class DividerImeController implements DisplayImeController.ImePositionProcessor {
    ...
    private void startAsyncAnimation() {
        ...
        this.mAnimation.addListener(new AnimatorListenerAdapter() {
            /* class com.android.wm.shell.legacysplitscreen.DividerImeController.AnonymousClass1 */
    ...
    private /* synthetic */ void lambda$startAsyncAnimation$0(ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$pause$1() {
        if (!this.mPaused) {
            this.mPaused = true;
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$resume$2() {
        if (this.mPaused) {
            this.mPaused = false;
