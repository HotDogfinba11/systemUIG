...
public class DividerView extends FrameLayout implements View.OnTouchListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public DividerView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mHandleDelegate = new View.AccessibilityDelegate() {
            /* class com.android.wm.shell.legacysplitscreen.DividerView.AnonymousClass1 */
            ...
            public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                ...
                DividerView.this.stopDragging((DividerView) currentPosition, (int) dismissStartTarget, (DividerSnapAlgorithm.SnapTarget) 250, (long) Interpolators.FAST_OUT_SLOW_IN);
                return true;
            }
        };
        this.mResetBackgroundRunnable = new Runnable() {
            /* class com.android.wm.shell.legacysplitscreen.DividerView.AnonymousClass2 */
    ...
    private void stopDragging(int i, DividerSnapAlgorithm.SnapTarget snapTarget, long j, Interpolator interpolator) {
    ...
    private ValueAnimator getFlingAnimator(int i, DividerSnapAlgorithm.SnapTarget snapTarget, final long j) {
        ...
        ofInt.addListener(new AnimatorListenerAdapter() {
            /* class com.android.wm.shell.legacysplitscreen.DividerView.AnonymousClass3 */
