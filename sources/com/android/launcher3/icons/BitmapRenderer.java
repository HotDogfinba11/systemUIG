...
public interface BitmapRenderer {
    ...
    static default Bitmap createSoftwareBitmap(int i, int i2, BitmapRenderer bitmapRenderer) {
    ...
    @TargetApi(28)
    static default Bitmap createHardwareBitmap(int i, int i2, BitmapRenderer bitmapRenderer) {
