...
public class NavigationBarView extends FrameLayout implements NavigationModeController.ModeChangedListener {
    ...
    public NavigationBarView(Context context, AttributeSet attributeSet) {
        ...
        this.mQuickStepAccessibilityDelegate = new View.AccessibilityDelegate() {
            /* class com.android.systemui.navigationbar.NavigationBarView.AnonymousClass1 */
        ...
        this.mRotationButtonListener = new NavigationBarView$$ExternalSyntheticLambda5(this);
        NavigationBarView$$ExternalSyntheticLambda6 navigationBarView$$ExternalSyntheticLambda6 = new NavigationBarView$$ExternalSyntheticLambda6(this);
        this.mNavbarOverlayVisibilityChangeCallback = navigationBarView$$ExternalSyntheticLambda6;
        this.mDockedListener = new NavigationBarView$$ExternalSyntheticLambda7(this);
        this.mPipListener = new NavigationBarView$$ExternalSyntheticLambda4(this);
        ...
        this.mRegionSamplingHelper = new RegionSamplingHelper(this, new RegionSamplingHelper.SamplingCallback() {
            /* class com.android.systemui.navigationbar.NavigationBarView.AnonymousClass2 */
        ...
        if (navigationBarOverlayController.isNavigationBarOverlayEnabled()) {
            ...
            navigationBarOverlayController2.init(navigationBarView$$ExternalSyntheticLambda6, new NavigationBarView$$ExternalSyntheticLambda8(edgeBackGestureHandler));
        }
    }
    ...
    public /* synthetic */ void lambda$new$6(Rect rect) {
        post(new NavigationBarView$$ExternalSyntheticLambda2(this, rect));
    }
