    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.mIsActive) {
            ...
            if (motionEvent.getAction() == 0) {
                this.mTouchingChild = this.mClickableChildren.stream().filter(NearestTouchFrame$$ExternalSyntheticLambda3.INSTANCE).filter(new NearestTouchFrame$$ExternalSyntheticLambda2(this, x, y)).findFirst().orElse(null);
            }
