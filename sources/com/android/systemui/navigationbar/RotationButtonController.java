...
public class RotationButtonController {
    ...
    private final IRotationWatcher.Stub mRotationWatcher = new IRotationWatcher.Stub() {
        /* class com.android.systemui.navigationbar.RotationButtonController.AnonymousClass1 */
        ...
        private /* synthetic */ void lambda$onRotationChanged$0(int i) {
        ...
        if ((z || this.mRotationButton.isVisible()) && (currentView = this.mRotationButton.getCurrentView()) != null && (imageDrawable = this.mRotationButton.getImageDrawable()) != null) {
            ...
            if (animator3 == null || !animator3.isRunning()) {
                ...
                ofFloat.addListener(new AnimatorListenerAdapter() {
                    /* class com.android.systemui.navigationbar.RotationButtonController.AnonymousClass2 */
    ...
    public class TaskStackListenerImpl extends TaskStackChangeListener {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$onActivityRequestedOrientationChanged$0(int i, ActivityManager.RunningTaskInfo runningTaskInfo) {
    ...
    public class ViewRippler {
        ...
        private ViewRippler() {
            this.mRipple = new Runnable() {
                /* class com.android.systemui.navigationbar.RotationButtonController.ViewRippler.AnonymousClass1 */
