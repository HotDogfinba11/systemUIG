        ...
        if (display != null && !isThreeButtonTaskbarEnabled()) {
            ...
            try {
                if (WindowManagerGlobal.getWindowManagerService().hasNavigationBar(displayId)) {
                    ...
                    navigationBar.createView(bundle).addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                        /* class com.android.systemui.navigationbar.NavigationBarController.AnonymousClass1 */
