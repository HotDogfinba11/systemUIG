...
public class NavigationBar implements View.OnAttachStateChangeListener, CommandQueue.Callbacks, NavigationModeController.ModeChangedListener, AccessibilityButtonModeObserver.ModeChangedListener {
    ...
    private final AccessibilityManager.AccessibilityServicesStateChangeListener mAccessibilityListener = new NavigationBar$$ExternalSyntheticLambda11(this);
    ...
    private final ContentObserver mAssistContentObserver = new ContentObserver(new Handler(Looper.getMainLooper())) {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass4 */
    ...
    private final Runnable mAutoDim = new NavigationBar$$ExternalSyntheticLambda15(this);
    private AutoHideController mAutoHideController;
    private final AutoHideUiElement mAutoHideUiElement = new AutoHideUiElement() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass1 */
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass8 */
    ...
    private final NotificationShadeDepthController.DepthListener mDepthListener = new NotificationShadeDepthController.DepthListener() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass7 */
        boolean mHasBlurs;
    ...
    private final Runnable mEnableLayoutTransitions = new NavigationBar$$ExternalSyntheticLambda14(this);
    ...
    private final DeviceConfig.OnPropertiesChangedListener mOnPropertiesChangedListener = new DeviceConfig.OnPropertiesChangedListener() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass5 */
    ...
    private final Runnable mOnVariableDurationHomeLongClick = new NavigationBar$$ExternalSyntheticLambda13(this);
    ...
    private NavigationBarTransitions.DarkIntensityListener mOrientationHandleIntensityListener = new NavigationBarTransitions.DarkIntensityListener() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass3 */
    ...
    private final OverviewProxyService.OverviewProxyListener mOverviewProxyListener = new OverviewProxyService.OverviewProxyListener() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass2 */
    ...
    private final Consumer<Integer> mRotationWatcher = new NavigationBar$$ExternalSyntheticLambda16(this);
    ...
    private final DeviceProvisionedController.DeviceProvisionedListener mUserSetupListener = new DeviceProvisionedController.DeviceProvisionedListener() {
        /* class com.android.systemui.navigationbar.NavigationBar.AnonymousClass6 */
    ...
    public void onViewAttachedToWindow(View view) {
        ...
        this.mNavigationBarView.setOnVerticalChangedListener(new NavigationBar$$ExternalSyntheticLambda12(this));
        this.mNavigationBarView.setOnTouchListener(new NavigationBar$$ExternalSyntheticLambda9(this));
        ...
        optional.ifPresent(new NavigationBar$$ExternalSyntheticLambda18(navigationBarView));
        ...
        optional2.ifPresent(new NavigationBar$$ExternalSyntheticLambda19(navigationBarView2));
    ...
    private void updateScreenPinningGestures() {
        ...
        if (isScreenPinningActive) {
            if (this.mNavigationBarView.isRecentsButtonVisible()) {
                onLongClickListener = new NavigationBar$$ExternalSyntheticLambda6(this);
            } else {
                onLongClickListener = new NavigationBar$$ExternalSyntheticLambda4(this);
            }
            backButton.setOnLongClickListener(onLongClickListener);
            recentsButton.setOnLongClickListener(new NavigationBar$$ExternalSyntheticLambda6(this));
        } else {
    ...
    private void prepareNavigationBarView() {
        ...
        recentsButton.setOnTouchListener(new NavigationBar$$ExternalSyntheticLambda8(this));
        this.mNavigationBarView.getHomeButton().setOnTouchListener(new NavigationBar$$ExternalSyntheticLambda7(this));
        ...
        accessibilityButton.setOnLongClickListener(new NavigationBar$$ExternalSyntheticLambda5(this));
    ...
    public boolean onHomeTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (telecomManager != null && telecomManager.isRinging() && this.mStatusBarLazy.get().isKeyguardShowing()) {
                ...
                this.mHomeButtonLongPressDurationMs.ifPresent(new NavigationBar$$ExternalSyntheticLambda17(this));
            }
    ...
    private boolean onLongPressRecents() {
        if (this.mRecentsOptional.isPresent() || !ActivityTaskManager.supportsMultiWindow(this.mContext) || ActivityManager.isLowRamDeviceStatic() || this.mOverviewProxyService.getProxy() != null || !this.mSplitScreenOptional.map(NavigationBar$$ExternalSyntheticLambda20.INSTANCE).orElse((U) Boolean.FALSE).booleanValue()) {
            return false;
        }
