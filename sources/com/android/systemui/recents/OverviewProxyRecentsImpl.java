...
public class OverviewProxyRecentsImpl implements RecentsImplementation {
    ...
    public void toggleRecentApps() {
        if (this.mOverviewProxyService.getProxy() != null) {
            ...
            if (lazy == null || !lazy.get().isKeyguardShowing()) {
                ...
                this.mStatusBarLazy.get().executeRunnableDismissingKeyguard(new OverviewProxyRecentsImpl$$ExternalSyntheticLambda1(this, overviewProxyRecentsImpl$$ExternalSyntheticLambda0), null, true, false, true);
            }
        }
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$toggleRecentApps$0() {
        try {
            if (this.mOverviewProxyService.getProxy() != null) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$toggleRecentApps$1(Runnable runnable) {
