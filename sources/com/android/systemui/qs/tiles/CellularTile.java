...
public class CellularTile extends QSTileImpl<QSTile.SignalState> {
    ...
    private void maybeShowDisableDialog() {
        ...
        AlertDialog create = new AlertDialog.Builder(this.mContext).setTitle(R$string.mobile_data_disable_title).setMessage(this.mContext.getString(R$string.mobile_data_disable_message, mobileDataNetworkName)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton(17039646, new CellularTile$$ExternalSyntheticLambda0(this)).create();
    ...
    private CharSequence getMobileDataContentName(CallbackInfo callbackInfo) {
        if (callbackInfo.roaming && !TextUtils.isEmpty(callbackInfo.dataContentDescription)) {
            ...
            return this.mContext.getString(R$string.mobile_data_text_format, string, charSequence);
