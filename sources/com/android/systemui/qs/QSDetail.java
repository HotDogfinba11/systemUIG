...
public class QSDetail extends LinearLayout {
    ...
    protected Callback mQsPanelCallback = new Callback() {
        ...
        public void onToggleStateChanged(final boolean z) {
            QSDetail.this.post(new Runnable() {
                /* class com.android.systemui.qs.QSDetail.AnonymousClass1.AnonymousClass1 */
        ...
        public void onShowingDetail(final DetailAdapter detailAdapter, final int i, final int i2) {
            QSDetail.this.post(new Runnable() {
                /* class com.android.systemui.qs.QSDetail.AnonymousClass1.AnonymousClass2 */
        ...
        public void onScanStateChanged(final boolean z) {
            QSDetail.this.post(new Runnable() {
                /* class com.android.systemui.qs.QSDetail.AnonymousClass1.AnonymousClass3 */
    ...
    private /* synthetic */ void lambda$setupDetailFooter$0(DetailAdapter detailAdapter, Intent intent, View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupDetailFooter$1(DetailAdapter detailAdapter, View view) {
        if (!this.mFalsingManager.isFalseTap(1)) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupDetailHeader$2(DetailAdapter detailAdapter, View view) {
        if (!this.mFalsingManager.isFalseTap(1)) {
    ...
    private void handleScanStateChanged(boolean z) {
        if (this.mScanState != z) {
            ...
            if (z) {
                ...
                alpha.withEndAction(new QSDetail$$ExternalSyntheticLambda3(animatable)).start();
                return;
            }
            this.mQsDetailHeaderProgress.animate().cancel();
            ViewPropertyAnimator alpha2 = this.mQsDetailHeaderProgress.animate().alpha(0.0f);
            Objects.requireNonNull(animatable);
            alpha2.withEndAction(new QSDetail$$ExternalSyntheticLambda4(animatable)).start();
        }
    }
