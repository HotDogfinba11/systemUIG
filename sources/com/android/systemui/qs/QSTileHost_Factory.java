...
public final class QSTileHost_Factory implements Factory<QSTileHost> {
    ...
    public QSTileHost get() {
        return newInstance(this.contextProvider.get(), this.iconControllerProvider.get(), this.defaultFactoryProvider.get(), this.mainHandlerProvider.get(), this.bgLooperProvider.get(), this.pluginManagerProvider.get(), this.tunerServiceProvider.get(), this.autoTilesProvider, this.dumpManagerProvider.get(), this.broadcastDispatcherProvider.get(), this.statusBarOptionalProvider.get(), this.qsLoggerProvider.get(), this.uiEventLoggerProvider.get(), this.userTrackerProvider.get(), this.secureSettingsProvider.get(), this.customTileStatePersisterProvider.get(), this.featureFlagsProvider.get());
    }
