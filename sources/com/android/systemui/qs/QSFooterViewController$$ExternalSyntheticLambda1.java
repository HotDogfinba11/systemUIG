...
public final /* synthetic */ class QSFooterViewController$$ExternalSyntheticLambda1 implements View.OnLayoutChangeListener {
    ...
    public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        this.f$0.lambda$onViewAttached$0(view, i, i2, i3, i4, i5, i6, i7, i8);
    }
}
