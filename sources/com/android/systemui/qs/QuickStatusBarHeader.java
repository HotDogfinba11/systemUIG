...
public class QuickStatusBarHeader extends FrameLayout {
    ...
    private void updateAlphaAnimator() {
        this.mAlphaAnimator = new TouchAnimator.Builder().addFloat(this.mSecurityHeaderView, "alpha", 0.0f, 1.0f).addFloat(this.mDateView, "alpha", 0.0f, 0.0f, 1.0f).addFloat(this.mClockDateView, "alpha", 1.0f, 0.0f, 0.0f).addFloat(this.mQSCarriers, "alpha", 0.0f, 1.0f).setListener(new TouchAnimator.ListenerAdapter() {
            /* class com.android.systemui.qs.QuickStatusBarHeader.AnonymousClass1 */

            @Override // com.android.systemui.qs.TouchAnimator.Listener, com.android.systemui.qs.TouchAnimator.ListenerAdapter
