...
public class QSTileViewImpl extends QSTileView implements HeightOverrideable {
    ...
    public final TextView m198getSecondaryLabel() {
    ...
    public final void updateResources() {
        ...
        if (textView != null) {
            ...
            FontSizeUtils.updateFontSize(m198getSecondaryLabel(), i);
            ...
            if (this.collapsed) {
                ...
                if (ignorableChildLinearLayout3 != null) {
                    ...
                    if (ignorableChildLinearLayout4 != null) {
                        ...
                        m198getSecondaryLabel().setAlpha(0.0f);
                    } else {
                        Intrinsics.throwUninitializedPropertyAccessException("labelContainer");
                        throw null;
                    }
    ...
    public void handleStateChanged(QSTile.State state) {
        ...
        if (textView != null) {
            ...
            if (!Objects.equals(m198getSecondaryLabel().getText(), state.secondaryLabel)) {
                m198getSecondaryLabel().setText(state.secondaryLabel);
                m198getSecondaryLabel().setVisibility(TextUtils.isEmpty(state.secondaryLabel) ? 8 : 0);
            }
            if (state.state != this.lastState) {
                ...
                if (animationsEnabled) {
                    ...
                    if (textView3 != null) {
                        ...
                        propertyValuesHolderArr[2] = QSTileViewImplKt.access$colorValuesHolder("secondaryLabel", m198getSecondaryLabel().getCurrentTextColor(), getSecondaryLabelColorForState(state.state));
                        int[] iArr2 = new int[2];
                        ImageView imageView = this.chevronView;
                        if (imageView != null) {
    ...
    private final void setSecondaryLabelColor(int i) {
        m198getSecondaryLabel().setTextColor(i);
    }
