...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileQueryHelper.TileStateListener {
            ...
            public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (viewHolder != TileAdapter.this.mCurrentDrag) {
                    ...
                    TileAdapter.this.mHandler.post(new Runnable() {
                        /* class com.android.systemui.qs.customize.TileAdapter.AnonymousClass5.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean canRemoveFromPosition(int i) {
        return canRemoveTiles() && isCurrentTile(i);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isCurrentTile(int i) {
        return i < this.mEditIndex;
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean canAddFromPosition(int i) {
        return i > this.mEditIndex;
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean addFromPosition(int i) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean removeFromPosition(int i) {
