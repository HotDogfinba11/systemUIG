...
public class GlobalActionsComponent extends SystemUI implements CommandQueue.Callbacks, GlobalActions.GlobalActionsManager {
    ...
    public void start() {
        ...
        ExtensionController.Extension<GlobalActions> build = withPlugin.withDefault(new GlobalActionsComponent$$ExternalSyntheticLambda1(provider)).withCallback(new GlobalActionsComponent$$ExternalSyntheticLambda0(this)).build();
