...
public class GlobalActionsDialogLite implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, ConfigurationController.ConfigurationListener, GlobalActionsPanelPlugin.Callbacks, LifecycleOwner {
    ...
    private ToggleState mAirplaneState;
    ...
    public GlobalActionsDialogLite(Context context, GlobalActions.GlobalActionsManager globalActionsManager, AudioManager audioManager, IDreamManager iDreamManager, DevicePolicyManager devicePolicyManager, LockPatternUtils lockPatternUtils, BroadcastDispatcher broadcastDispatcher, TelephonyListenerManager telephonyListenerManager, GlobalSettings globalSettings, SecureSettings secureSettings, Vibrator vibrator, Resources resources, ConfigurationController configurationController, KeyguardStateController keyguardStateController, UserManager userManager, TrustManager trustManager, IActivityManager iActivityManager, TelecomManager telecomManager, MetricsLogger metricsLogger, SysuiColorExtractor sysuiColorExtractor, IStatusBarService iStatusBarService, NotificationShadeWindowController notificationShadeWindowController, IWindowManager iWindowManager, Executor executor, UiEventLogger uiEventLogger, GlobalActionsInfoProvider globalActionsInfoProvider, RingerModeTracker ringerModeTracker, SysUiState sysUiState, Handler handler, PackageManager packageManager, StatusBar statusBar, KeyguardUpdateMonitor keyguardUpdateMonitor) {
        ...
        this.mBroadcastReceiver = new BroadcastReceiver() {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass5 */
        ...
        AnonymousClass6 r8 = new TelephonyCallback.ServiceStateListener() {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass6 */
        ...
        AnonymousClass7 r9 = new ContentObserver(this.mMainHandler) {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass7 */
        ...
        this.mHandler = new Handler() {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass8 */
    ...
    public ActionsDialogLite createDialog() {
        initDialogItems();
        ActionsDialogLite actionsDialogLite = new ActionsDialogLite(this.mContext, R$style.Theme_SystemUI_Dialog_GlobalActionsLite, this.mAdapter, this.mOverflowAdapter, this.mSysuiColorExtractor, this.mStatusBarService, this.mNotificationShadeWindowController, this.mSysUiState, new GlobalActionsDialogLite$$ExternalSyntheticLambda1(this), this.mKeyguardShowing, this.mPowerAdapter, this.mUiEventLogger, this.mInfoProvider, this.mStatusBar, this.mKeyguardUpdateMonitor, this.mLockPatternUtils);
    ...
    public final class PowerOptionsAction extends SinglePressAction {
        ...
        private PowerOptionsAction() {
            super(R$drawable.ic_settings_power, 17040327);
        }
    ...
    protected abstract class EmergencyAction extends SinglePressAction {
        ...
        @Override // com.android.systemui.globalactions.GlobalActionsDialogLite.Action, com.android.systemui.globalactions.GlobalActionsDialogLite.SinglePressAction
    ...
    public class EmergencyDialerAction extends EmergencyAction {
        private EmergencyDialerAction() {
            super(R$drawable.ic_emergency_star, 17040322);
        }
    ...
    public class ScreenshotAction extends SinglePressAction {
        ...
        ScreenshotAction() {
            super(17302826, 17040329);
        }

        @Override // com.android.systemui.globalactions.GlobalActionsDialogLite.Action
        public void onPress() {
            GlobalActionsDialogLite.this.mHandler.postDelayed(new Runnable() {
                /* class com.android.systemui.globalactions.GlobalActionsDialogLite.ScreenshotAction.AnonymousClass1 */
        ...
        public boolean is2ButtonNavigationEnabled() {
            return 1 == GlobalActionsDialogLite.this.mContext.getResources().getInteger(17694865);
        }
    }
    ...
    public class BugReportAction extends SinglePressAction implements LongPressAction {
        ...
        public void onPress() {
            if (!ActivityManager.isUserAMonkey()) {
                GlobalActionsDialogLite.this.mHandler.postDelayed(new Runnable() {
                    /* class com.android.systemui.globalactions.GlobalActionsDialogLite.BugReportAction.AnonymousClass1 */
    ...
    public final class LogoutAction extends SinglePressAction {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$onPress$0() {
            try {
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302833, 17040330) {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass1 */
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302302, 17040320) {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass2 */
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302875, 17040334) {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass3 */
        ...
        if (this.mUserManager.isUserSwitcherEnabled()) {
            for (final UserInfo userInfo2 : this.mUserManager.getUsers()) {
                if (userInfo2.supportsSwitchToByUser()) {
                    ...
                    sb.append(str2);
                    sb.append(z ? " ✔" : "");
                    addIfShouldShowAction(list, new SinglePressAction(17302703, createFromPath, sb.toString()) {
                        /* class com.android.systemui.globalactions.GlobalActionsDialogLite.AnonymousClass4 */
    ...
    public class MyAdapter extends MultiListLayout.MultiListAdapter {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ boolean lambda$getView$1(int i, View view) {
    ...
    public class AirplaneModeAction extends ToggleAction {
        ...
        AirplaneModeAction() {
            super(17302480, 17302482, 17040338, 17040337, 17040336);
        }
    ...
    public class SilentModeToggleAction extends ToggleAction {
        ...
        SilentModeToggleAction() {
            super(17302320, 17302319, 17040333, 17040332, 17040331);
        }
    ...
    public static class ActionsDialogLite extends Dialog implements ColorExtractor.OnColorsChangedListener {
        ...
        protected GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
            /* class com.android.systemui.globalactions.GlobalActionsDialogLite.ActionsDialogLite.AnonymousClass1 */
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$createPowerOverflowPopup$0(AdapterView adapterView, View view, int i, long j) {
            this.mOverflowAdapter.onClickItem(i);
        }

        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ boolean lambda$createPowerOverflowPopup$1(AdapterView adapterView, View view, int i, long j) {
        ...
        public void initializeLayout() {
            ...
            multiListLayout.setListViewAccessibilityDelegate(new View.AccessibilityDelegate() {
                /* class com.android.systemui.globalactions.GlobalActionsDialogLite.ActionsDialogLite.AnonymousClass2 */

                public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                    accessibilityEvent.getText().add(ActionsDialogLite.this.mContext.getString(17040335));
                    return true;
                }
            });
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ boolean lambda$initializeLayout$2(View view, MotionEvent motionEvent) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$initializeLayout$3(View view) {
        ...
        private void showSmartLockDisabledMessage() {
            ...
            inflate.animate().alpha(1.0f).setDuration(333).setListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.globalactions.GlobalActionsDialogLite.ActionsDialogLite.AnonymousClass3 */

                public void onAnimationEnd(Animator animator) {
                    inflate.animate().alpha(0.0f).setDuration(333).setStartDelay((long) recommendedTimeoutMillis);
                }
            });
        }
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$showDialog$6(ValueAnimator valueAnimator) {
        ...
        public void lambda$dismiss$7() {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.globalactions.GlobalActionsDialogLite.ActionsDialogLite.AnonymousClass4 */
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$dismissInternal$8(ValueAnimator valueAnimator) {
