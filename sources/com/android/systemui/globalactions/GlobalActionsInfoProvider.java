...
public final class GlobalActionsInfoProvider {
    ...
    public GlobalActionsInfoProvider(Context context2, QuickAccessWalletClient quickAccessWalletClient, ControlsController controlsController2, ActivityStarter activityStarter2) {
    ...
    public final void addPanel(Context context2, ViewGroup viewGroup, int i, Runnable runnable) {
        Intrinsics.checkNotNullParameter(context2, "context");
        ...
        if (!(context2.getResources().getConfiguration().orientation == 2) || i <= 4) {
            ...
            if (textView != null) {
                textView.setText(context2.getString(R$string.global_actions_change_description, serviceLabel));
            }
