...
public final class DozeTriggers_Factory implements Factory<DozeTriggers> {
    ...
    public DozeTriggers get() {
        return newInstance(this.contextProvider.get(), this.dozeHostProvider.get(), this.configProvider.get(), this.dozeParametersProvider.get(), this.sensorManagerProvider.get(), this.wakeLockProvider.get(), this.dockManagerProvider.get(), this.proximitySensorProvider.get(), this.proxCheckProvider.get(), this.dozeLogProvider.get(), this.broadcastDispatcherProvider.get(), this.secureSettingsProvider.get(), this.authControllerProvider.get(), this.mainExecutorProvider.get(), this.uiEventLoggerProvider.get(), this.keyguardStateControllerProvider.get());
    }
