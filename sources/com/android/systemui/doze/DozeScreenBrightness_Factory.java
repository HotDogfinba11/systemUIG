...
public final class DozeScreenBrightness_Factory implements Factory<DozeScreenBrightness> {
    ...
    public DozeScreenBrightness get() {
        return newInstance(this.contextProvider.get(), this.serviceProvider.get(), this.sensorManagerProvider.get(), this.lightSensorOptionalProvider.get(), this.hostProvider.get(), this.handlerProvider.get(), this.alwaysOnDisplayPolicyProvider.get(), this.wakefulnessLifecycleProvider.get(), this.dozeParametersProvider.get(), this.dockManagerProvider.get(), this.unlockedScreenOffAnimationControllerProvider.get());
    }
