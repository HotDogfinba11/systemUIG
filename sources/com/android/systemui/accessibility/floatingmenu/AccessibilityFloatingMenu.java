...
public class AccessibilityFloatingMenu implements IAccessibilityFloatingMenu {
    ...
    public AccessibilityFloatingMenu(Context context) {
        ...
        this.mContentObserver = new ContentObserver(handler) {
            /* class com.android.systemui.accessibility.floatingmenu.AccessibilityFloatingMenu.AnonymousClass1 */
        ...
        this.mSizeContentObserver = new ContentObserver(handler) {
            /* class com.android.systemui.accessibility.floatingmenu.AccessibilityFloatingMenu.AnonymousClass2 */
        ...
        this.mFadeOutContentObserver = new ContentObserver(handler) {
            /* class com.android.systemui.accessibility.floatingmenu.AccessibilityFloatingMenu.AnonymousClass3 */
        ...
        this.mEnabledA11yServicesContentObserver = new ContentObserver(handler) {
            /* class com.android.systemui.accessibility.floatingmenu.AccessibilityFloatingMenu.AnonymousClass4 */
