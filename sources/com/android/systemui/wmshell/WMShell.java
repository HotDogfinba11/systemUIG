...
public final class WMShell extends SystemUI implements CommandQueue.Callbacks, ProtoTraceable<SystemUiTraceProto> {
    ...
    public void initPip(final Pip pip) {
        this.mCommandQueue.addCallback((CommandQueue.Callbacks) new CommandQueue.Callbacks() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass1 */
        ...
        AnonymousClass2 r0 = new KeyguardUpdateMonitorCallback() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass2 */
        ...
        this.mConfigurationController.addCallback(new ConfigurationController.ConfigurationListener() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass3 */
    ...
    public void initSplitScreen(final LegacySplitScreen legacySplitScreen) {
        AnonymousClass4 r0 = new KeyguardUpdateMonitorCallback() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass4 */
    ...
    public void initOneHanded(final OneHanded oneHanded) {
        oneHanded.registerTransitionCallback(new OneHandedTransitionCallback() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass5 */
        ...
        oneHanded.registerEventCallback(new OneHandedEventCallback() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass6 */
        ...
        AnonymousClass7 r0 = new KeyguardUpdateMonitorCallback() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass7 */
        ...
        this.mKeyguardUpdateMonitor.registerCallback(r0);
        AnonymousClass8 r02 = new WakefulnessLifecycle.Observer() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass8 */
        ...
        this.mScreenLifecycle.addObserver(new ScreenLifecycle.Observer() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass9 */
        ...
        this.mCommandQueue.addCallback((CommandQueue.Callbacks) new CommandQueue.Callbacks() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass10 */
        ...
        this.mConfigurationController.addCallback(new ConfigurationController.ConfigurationListener() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass11 */
    ...
    public void initHideDisplayCutout(final HideDisplayCutout hideDisplayCutout) {
        this.mConfigurationController.addCallback(new ConfigurationController.ConfigurationListener() {
            /* class com.android.systemui.wmshell.WMShell.AnonymousClass12 */
