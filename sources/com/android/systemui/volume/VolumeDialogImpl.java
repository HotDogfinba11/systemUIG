...
public class VolumeDialogImpl implements VolumeDialog, ConfigurationController.ConfigurationListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    private final VolumeDialogController.Callbacks mControllerCallbackH = new VolumeDialogController.Callbacks() {
        /* class com.android.systemui.volume.VolumeDialogImpl.AnonymousClass6 */
    ...
    public VolumeDialogImpl(Context context) {
        ...
        if (z) {
            this.mCrossWindowBlurEnabledListener = new VolumeDialogImpl$$ExternalSyntheticLambda23(this, contextThemeWrapper.getColor(R$color.volume_dialog_background_color_above_blur), contextThemeWrapper.getColor(R$color.volume_dialog_background_color));
        }
        initDimens();
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$new$0(int i, int i2, Boolean bool) {
    ...
    private void initDialog() {
        ...
        this.mDialogView.setOnHoverListener(new VolumeDialogImpl$$ExternalSyntheticLambda9(this));
        ...
        if (findViewById != null) {
            ...
            this.mRingerAndDrawerContainer.post(new VolumeDialogImpl$$ExternalSyntheticLambda13(this));
        }
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initDialog$2(DialogInterface dialogInterface) {
        ...
        this.mDialogView.animate().alpha(1.0f).translationX(0.0f).setDuration((long) this.mDialogShowAnimationDurationMs).setInterpolator(new SystemUIInterpolators$LogDecelerateInterpolator()).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda16(this)).start();
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initDialog$1() {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initDialog$3(DialogInterface dialogInterface) {
        this.mDialogView.getViewTreeObserver().removeOnComputeInternalInsetsListener(this);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ boolean lambda$initDialog$4(View view, MotionEvent motionEvent) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initDialog$5() {
    ...
    private void initRow(VolumeRow volumeRow, int i, int i2, int i3, boolean z, boolean z2) {
        ...
        if (volumeRow.stream != 10) {
            volumeRow.icon.setOnClickListener(new VolumeDialogImpl$$ExternalSyntheticLambda8(this, volumeRow, i));
        } else {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initRow$6(VolumeRow volumeRow, int i, View view) {
        int i2 = 0;
        boolean z = true;
    ...
    private void setupRingerDrawer() {
        ...
        if (viewGroup != null) {
            ...
            this.mSelectedRingerContainer.setOnClickListener(new VolumeDialogImpl$$ExternalSyntheticLambda7(this));
            ...
            this.mRingerDrawerIconColorAnimator.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.volume.VolumeDialogImpl.AnonymousClass2 */
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupRingerDrawer$7(View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupRingerDrawer$8(int i, int i2, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setupRingerDrawer$9(ValueAnimator valueAnimator) {
    ...
    private void showRingerDrawer() {
        if (!this.mIsRingerDrawerOpen) {
            ...
            this.mSelectedRingerContainer.animate().setInterpolator(interpolator).setDuration(250).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda12(this));
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$showRingerDrawer$10() {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$hideRingerDrawer$11() {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initSettingsH$12(View view) {
    ...
    private /* synthetic */ void lambda$initRingerH$13(android.view.View r6) {
        /*
            r5 = this;
    ...
    private void initODICaptionsH() {
        ...
        if (captionsToggleImageButton != null) {
            captionsToggleImageButton.setOnConfirmedTapListener(new VolumeDialogImpl$$ExternalSyntheticLambda10(this), this.mHandler);
        }
        this.mController.getCaptionsComponentState(false);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initODICaptionsH$14() {
    ...
    public void showCaptionsTooltip() {
        ...
        if (view != null) {
            view.setAlpha(0.0f);
            this.mHandler.post(new VolumeDialogImpl$$ExternalSyntheticLambda18(this));
        }
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$showCaptionsTooltip$15(View view) {
        hideCaptionsTooltip();
        Events.writeEvent(22, new Object[0]);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$showCaptionsTooltip$17() {
        ...
        this.mODICaptionsTooltipView.animate().alpha(1.0f).setStartDelay((long) this.mDialogShowAnimationDurationMs).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda14(this)).start();
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$showCaptionsTooltip$16() {
        if (D.BUG) {
    ...
    private void hideCaptionsTooltip() {
        ...
        if (view != null && view.getVisibility() == 0) {
            ...
            this.mODICaptionsTooltipView.animate().alpha(0.0f).setStartDelay(0).setDuration((long) this.mDialogHideAnimationDurationMs).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda15(this)).start();
        }
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$hideCaptionsTooltip$18() {
        View view = this.mODICaptionsTooltipView;
        if (view != null) {
    ...
    private void updateCaptionsIcon() {
        ...
        if (this.mODICaptionsIcon.getOptedOut() != isCaptionStreamOptedOut) {
            this.mHandler.post(new VolumeDialogImpl$$ExternalSyntheticLambda22(this, isCaptionStreamOptedOut));
        }
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$updateCaptionsIcon$19(boolean z) {
    ...
    private void maybeShowToastH(int i) {
        ...
        if (i2 <= 12) {
            String str = null;
            if (i == 0) {
                str = this.mContext.getString(17041565);
            } else if (i != 2) {
                str = this.mContext.getString(17041566);
            } else {
    ...
    public void dismissH(int i) {
        ...
        if (!this.mIsAnimatingDismiss) {
            ...
            ViewPropertyAnimator withEndAction = this.mDialogView.animate().alpha(0.0f).setDuration((long) this.mDialogHideAnimationDurationMs).setInterpolator(new SystemUIInterpolators$LogAccelerateInterpolator()).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda19(this));
            if (!isLandscape()) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$dismissH$21() {
        this.mHandler.postDelayed(new VolumeDialogImpl$$ExternalSyntheticLambda17(this), 50);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$dismissH$20() {
    ...
    private void showSafetyWarningH(int r4) {
        ...
        L_0x0008:
            ...
            return
        L_0x0011:
            com.android.systemui.volume.VolumeDialogImpl$4 r0 = new com.android.systemui.volume.VolumeDialogImpl$4     // Catch:{ all -> 0x002c }
    ...
    private Runnable getSinglePressFor(ImageButton imageButton) {
        return new VolumeDialogImpl$$ExternalSyntheticLambda21(this, imageButton);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$getSinglePressFor$22(ImageButton imageButton) {
        if (imageButton != null) {
    ...
    private Runnable getSingleUnpressFor(ImageButton imageButton) {
        return new VolumeDialogImpl$$ExternalSyntheticLambda11(imageButton);
    }
        ...
        if (this.mTopContainer != null) {
            ...
            if (isLandscape()) {
                this.mRingerAndDrawerContainer.setOutlineProvider(new ViewOutlineProvider() {
                    /* class com.android.systemui.volume.VolumeDialogImpl.AnonymousClass5 */
