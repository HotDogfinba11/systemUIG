...
public class ZenModePanel extends FrameLayout {
    ...
    private static String foreverSummary(Context context) {
        return context.getString(17041664);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
        r20.mBucketIndex = r4;
        r3 = android.service.notification.ZenModeConfig.toTimeCondition(r20.mContext, r15, r17, android.app.ActivityManager.getCurrentUser(), false);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onClickTimeButton(android.view.View r21, com.android.systemui.volume.ZenModePanel.ConditionTag r22, boolean r23, int r24) {
        /*
