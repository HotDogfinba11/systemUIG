...
public final class ScreenRecordDialog_Factory implements Factory<ScreenRecordDialog> {
    ...
    public static ScreenRecordDialog newInstance(RecordingController recordingController, UserContextProvider userContextProvider2) {
        return new ScreenRecordDialog(recordingController, userContextProvider2);
    }
}
