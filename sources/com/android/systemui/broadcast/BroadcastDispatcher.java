...
public class BroadcastDispatcher implements Dumpable {
    ...
    public BroadcastDispatcher(Context context2, Looper looper, Executor executor, DumpManager dumpManager2, BroadcastDispatcherLogger broadcastDispatcherLogger, UserTracker userTracker2) {
