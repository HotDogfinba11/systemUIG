...
public class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    private /* synthetic */ ScreenshotController.SavedImageData.ActionTransition lambda$createShareAction$0(Uri uri, Context context, Resources resources) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ ScreenshotController.SavedImageData.ActionTransition lambda$createEditAction$1(Context context, Uri uri, Resources resources) {
        ScreenshotController.SavedImageData.ActionTransition actionTransition = this.mSharedElementTransition.get();
