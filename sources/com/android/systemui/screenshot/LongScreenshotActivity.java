...
public class LongScreenshotActivity extends Activity {
    ...
    private void onLongScreenshotReceived(ScrollCaptureController.LongScreenshot longScreenshot) {
        ...
        this.mEnterTransitionView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            /* class com.android.systemui.screenshot.LongScreenshotActivity.AnonymousClass1 */
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.android.systemui.screenshot.LongScreenshotActivity.AnonymousClass2.$SwitchMap$com$android$systemui$screenshot$LongScreenshotActivity$PendingAction = r0
            ...
            L_0x0012:
                int[] r0 = com.android.systemui.screenshot.LongScreenshotActivity.AnonymousClass2.$SwitchMap$com$android$systemui$screenshot$LongScreenshotActivity$PendingAction     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.android.systemui.screenshot.LongScreenshotActivity.AnonymousClass2.$SwitchMap$com$android$systemui$screenshot$LongScreenshotActivity$PendingAction     // Catch:{ NoSuchFieldError -> 0x0028 }
