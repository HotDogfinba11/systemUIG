...
public class ScreenshotView extends FrameLayout implements ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public ScreenshotView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        GestureDetector gestureDetector = new GestureDetector(((FrameLayout) this).mContext, new GestureDetector.SimpleOnGestureListener() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass1 */
        ...
        addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass2 */
    ...
    public void showScrollChip(String str, Runnable runnable) {
        ...
        this.mScrollChip.setOnClickListener(new ScreenshotView$$ExternalSyntheticLambda19(this, str, runnable));
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$showScrollChip$0(String str, Runnable runnable, View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startInputListening$1(InputEvent inputEvent) {
    ...
    public void onFinishInflate() {
        ...
        this.mNavMode = getResources().getInteger(17694865);
    ...
    public AnimatorSet createScreenshotDropInAnimation(final Rect rect, boolean z) {
        ...
        ofFloat3.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass3 */
        ...
        ofFloat3.addUpdateListener(new ScreenshotView$$ExternalSyntheticLambda9(this, 0.468f, f, 0.468f, pointF, pointF2, 0.4f));
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass4 */
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                ScreenshotView.this.mDismissButton.setY((pointF2.y - width) - ((((float) rect.height()) * width) / 2.0f));
            ...
            /* access modifiers changed from: public */
            private /* synthetic */ void lambda$onAnimationEnd$0(View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotDropInAnimation$2(ValueAnimator valueAnimator) {
        this.mScreenshotFlash.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotDropInAnimation$3(ValueAnimator valueAnimator) {
        this.mScreenshotFlash.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotDropInAnimation$4(float f, float f2, float f3, PointF pointF, PointF pointF2, float f4, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotDropInAnimation$5(ValueAnimator valueAnimator) {
    ...
    public ValueAnimator createScreenshotActionsShadeAnimation() {
        ...
        this.mShareChip.setContentDescription(((FrameLayout) this).mContext.getString(17041372));
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotActionsShadeAnimation$6(View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotActionsShadeAnimation$7(View view) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotActionsShadeAnimation$8(View view) {
        this.mShareChip.setIsPending(false);
        this.mEditChip.setIsPending(false);
        ScreenshotActionChip screenshotActionChip = this.mQuickShareChip;
        if (screenshotActionChip != null) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotActionsShadeAnimation$9(float f, ArrayList arrayList, ValueAnimator valueAnimator) {
        float animatedFraction = valueAnimator.getAnimatedFraction();
    ...
    public void setChipIntents(ScreenshotController.SavedImageData savedImageData) {
        ...
        if (pendingInteraction != null) {
            ...
            for (Notification.Action action : savedImageData.smartActions) {
                ...
                screenshotActionChip2.setPendingIntent(action.actionIntent, new ScreenshotView$$ExternalSyntheticLambda21(this));
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setChipIntents$10(ScreenshotController.SavedImageData savedImageData, View view) {
        this.mUiEventLogger.log(ScreenshotEvent.SCREENSHOT_SHARE_TAPPED);
        startSharedTransition(savedImageData.shareTransition.get());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setChipIntents$11(ScreenshotController.SavedImageData savedImageData, View view) {
        this.mUiEventLogger.log(ScreenshotEvent.SCREENSHOT_EDIT_TAPPED);
        startSharedTransition(savedImageData.editTransition.get());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setChipIntents$12(ScreenshotController.SavedImageData savedImageData, View view) {
        this.mUiEventLogger.log(ScreenshotEvent.SCREENSHOT_PREVIEW_TAPPED);
        startSharedTransition(savedImageData.editTransition.get());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setChipIntents$13() {
    ...
    public static /* synthetic */ class AnonymousClass9 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.android.systemui.screenshot.ScreenshotView.AnonymousClass9.$SwitchMap$com$android$systemui$screenshot$ScreenshotView$PendingInteraction = r0
            ...
            L_0x0012:
                int[] r0 = com.android.systemui.screenshot.ScreenshotView.AnonymousClass9.$SwitchMap$com$android$systemui$screenshot$ScreenshotView$PendingInteraction     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.android.systemui.screenshot.ScreenshotView.AnonymousClass9.$SwitchMap$com$android$systemui$screenshot$ScreenshotView$PendingInteraction     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.android.systemui.screenshot.ScreenshotView.AnonymousClass9.$SwitchMap$com$android$systemui$screenshot$ScreenshotView$PendingInteraction     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.screenshot.ScreenshotView.AnonymousClass9.<clinit>():void");
        }
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$setChipIntents$14() {
        this.mUiEventLogger.log(ScreenshotEvent.SCREENSHOT_SMART_ACTION_TAPPED);
        animateDismissal();
    }
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$addQuickShareChip$15(View view) {
        this.mShareChip.setIsPending(false);
        this.mEditChip.setIsPending(false);
    ...
    public void startLongScreenshotTransition(Rect rect, final Runnable runnable, ScrollCaptureController.LongScreenshot longScreenshot) {
        ...
        if (this.mShowScrollablePreview) {
            ...
            ofFloat2.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass5 */
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass6 */
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass7 */
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startLongScreenshotTransition$16(ValueAnimator valueAnimator) {
        this.mScrollingScrim.setAlpha(1.0f - valueAnimator.getAnimatedFraction());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startLongScreenshotTransition$17(float f, float f2, Rect rect, float f3, ValueAnimator valueAnimator) {
        float animatedFraction = valueAnimator.getAnimatedFraction();
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startLongScreenshotTransition$18(ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$prepareScrollingTransition$19(ValueAnimator valueAnimator) {
    ...
    private void animateDismissal(Animator animator) {
        this.mDismissAnimation = animator;
        animator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.screenshot.ScreenshotView.AnonymousClass8 */
    ...
    private AnimatorSet createScreenshotTranslateDismissAnimation() {
        ...
        if (this.mDirectionLTR) {
            f = (this.mScreenshotPreviewBorder.getX() + ((float) this.mScreenshotPreviewBorder.getWidth())) * -1.0f;
        } else {
            f = ((float) this.mDisplayMetrics.widthPixels) - this.mScreenshotPreviewBorder.getX();
        }
        ofFloat2.addUpdateListener(new ScreenshotView$$ExternalSyntheticLambda8(this, f));
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotTranslateDismissAnimation$20(ValueAnimator valueAnimator) {
        setAlpha(1.0f - valueAnimator.getAnimatedFraction());
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotTranslateDismissAnimation$21(float f, ValueAnimator valueAnimator) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$createScreenshotFadeDismissAnimation$22(ValueAnimator valueAnimator) {
    ...
    public class SwipeDismissHandler implements View.OnTouchListener {
        ...
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$createSwipeDismissAnimation$0(float f, float f2, ValueAnimator valueAnimator) {
        ...
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$createSwipeReturnAnimation$1(float f, float f2, ValueAnimator valueAnimator) {
            ScreenshotView.this.mScreenshotStatic.setTranslationX(MathUtils.lerp(f, f2, valueAnimator.getAnimatedFraction()));
        }
    }
}
