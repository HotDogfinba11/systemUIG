...
public class PowerUI extends SystemUI implements CommandQueue.Callbacks {
    ...
    public void updateBatteryWarningLevels() {
        ...
        int integer2 = this.mContext.getResources().getInteger(17694845);
        if (integer2 < integer) {
            integer2 = integer;
        }
        ...
        iArr[0] = integer2;
        iArr[1] = integer;
        this.mLowBatteryAlertCloseLevel = iArr[0] + this.mContext.getResources().getInteger(17694844);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.os.action.POWER_SAVE_MODE_CHANGED".equals(action)) {
                ...
                if (i4 != 0 || PowerUI.this.mInvalidCharger == 0) {
                    ...
                    PowerUI.this.mLastShowWarningTask = ThreadUtils.postOnBackgroundThread(new PowerUI$Receiver$$ExternalSyntheticLambda1(this, z, findBatteryLevelBucket2));
                    return;
                }
