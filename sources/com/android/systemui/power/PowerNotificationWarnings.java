...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
        ...
        if (this.mThermalShutdownDialog == null) {
            ...
            if (!string.isEmpty()) {
                systemUIDialog.setNeutralButton(R$string.thermal_shutdown_dialog_help_text, new DialogInterface.OnClickListener() {
                    /* class com.android.systemui.power.PowerNotificationWarnings.AnonymousClass2 */
    ...
    public void showUsbHighTemperatureAlarm() {
        this.mHandler.post(new PowerNotificationWarnings$$ExternalSyntheticLambda9(this));
    }
    ...
    public /* synthetic */ void lambda$showUsbHighTemperatureAlarmInternal$5(DialogInterface dialogInterface, int i) {
        ...
        ((ActivityStarter) Dependency.get(ActivityStarter.class)).startActivity(intent, true, (ActivityStarter.Callback) new PowerNotificationWarnings$$ExternalSyntheticLambda8(this));
    }
    ...
    private void showStartSaverConfirmation(Bundle bundle) {
        if (this.mSaverConfirmation == null) {
            ...
            if (z) {
                ...
                systemUIDialog.setPositiveButton(17040027, new PowerNotificationWarnings$$ExternalSyntheticLambda3(this, i, i2));
            } else {
        ...
        for (Annotation annotation : annotationArr) {
            if ("url".equals(annotation.getValue())) {
                ...
                AnonymousClass3 r8 = new URLSpan(charSequence) {
                    /* class com.android.systemui.power.PowerNotificationWarnings.AnonymousClass3 */
