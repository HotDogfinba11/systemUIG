...
public interface NotificationsModule {
    static default NotificationEntryManager provideNotificationEntryManager(NotificationEntryManagerLogger notificationEntryManagerLogger, NotificationGroupManagerLegacy notificationGroupManagerLegacy, FeatureFlags featureFlags, Lazy<NotificationRowBinder> lazy, Lazy<NotificationRemoteInputManager> lazy2, LeakDetector leakDetector, ForegroundServiceDismissalFeatureController foregroundServiceDismissalFeatureController, IStatusBarService iStatusBarService) {
    ...
    static default VisualStabilityManager provideVisualStabilityManager(FeatureFlags featureFlags, NotificationEntryManager notificationEntryManager, Handler handler, StatusBarStateController statusBarStateController, WakefulnessLifecycle wakefulnessLifecycle) {
    ...
    static default GroupMembershipManager provideGroupMembershipManager(FeatureFlags featureFlags, Lazy<NotificationGroupManagerLegacy> lazy) {
    ...
    static default GroupExpansionManager provideGroupExpansionManager(FeatureFlags featureFlags, Lazy<GroupMembershipManager> lazy, Lazy<NotificationGroupManagerLegacy> lazy2) {
        if (featureFlags.isNewNotifPipelineRenderingEnabled()) {
