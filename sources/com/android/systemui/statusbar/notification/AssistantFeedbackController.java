...
public class AssistantFeedbackController {
    ...
    public AssistantFeedbackController(Handler handler, Context context, DeviceConfigProxy deviceConfigProxy) {
        AnonymousClass1 r0 = new DeviceConfig.OnPropertiesChangedListener() {
            /* class com.android.systemui.statusbar.notification.AssistantFeedbackController.AnonymousClass1 */
    ...
    public Pair<Integer, Integer> getFeedbackResources(NotificationEntry notificationEntry) {
        ...
        if (feedbackStatus == 1) {
            return new Pair<>(17302438, 17040815);
        }
        if (feedbackStatus == 2) {
            return new Pair<>(17302441, 17040818);
        }
        if (feedbackStatus == 3) {
            return new Pair<>(17302442, 17040817);
        }
        if (feedbackStatus != 4) {
            return new Pair<>(0, 0);
        }
        return new Pair<>(17302439, 17040816);
    }
