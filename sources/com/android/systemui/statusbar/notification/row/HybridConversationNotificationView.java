...
public class HybridConversationNotificationView extends HybridNotificationView {
    ...
    public void onFinishInflate() {
        ...
        this.mConversationIconView = (ImageView) requireViewById(16908894);
        this.mConversationFacePile = requireViewById(16908889);
    ...
    public void bind(CharSequence charSequence, CharSequence charSequence2, View view) {
        ...
        if (conversationIcon != null) {
            ...
            View requireViewById = requireViewById(16908889);
            this.mConversationFacePile = requireViewById;
            ImageView imageView = (ImageView) requireViewById.requireViewById(16908891);
            ImageView imageView2 = (ImageView) this.mConversationFacePile.requireViewById(16908890);
            ImageView imageView3 = (ImageView) this.mConversationFacePile.requireViewById(16908892);
