...
public class ExpandableNotificationRow extends ActivatableNotificationView implements PluginListener<NotificationMenuRowPlugin>, SwipeableView {
    ...
    private final Runnable mExpireRecentlyAlertedFlag = new ExpandableNotificationRow$$ExternalSyntheticLambda6(this);
    ...
    public View.OnClickListener getSnoozeClickListener(NotificationMenuRowPlugin.MenuItem menuItem) {
        return new ExpandableNotificationRow$$ExternalSyntheticLambda1(this, menuItem);
    }
    ...
    public void setOnFeedbackClickListener(CoordinateOnClickListener coordinateOnClickListener) {
        this.mOnFeedbackClickListener = new ExpandableNotificationRow$$ExternalSyntheticLambda2(this, coordinateOnClickListener);
    }
    ...
    private void animateShowingPublic(long j, long j2, boolean z) {
        ...
        for (View view : viewArr3) {
            ...
            view.animate().cancel();
            view.animate().alpha(0.0f).setStartDelay(j).setDuration(j2).withEndAction(new ExpandableNotificationRow$$ExternalSyntheticLambda5(view));
        }
