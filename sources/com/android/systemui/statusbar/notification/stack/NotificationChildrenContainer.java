...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    private void initDimens() {
        ...
        this.mCollapsedBottompadding = (float) resources.getDimensionPixelSize(17105377);
        ...
        if (viewGroup != calculateDesiredHeader) {
            if (z) {
                if (calculateDesiredHeader == null || viewGroup == null) {
                    ...
                    wrapperForView2.transformTo(wrapperForView, new NotificationChildrenContainer$$ExternalSyntheticLambda0(this));
