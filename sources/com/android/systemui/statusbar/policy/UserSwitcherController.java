...
public class UserSwitcherController implements Dumpable {
    ...
    public UserSwitcherController(Context context, UserManager userManager, UserTracker userTracker, KeyguardStateController keyguardStateController, DeviceProvisionedController deviceProvisionedController, DevicePolicyManager devicePolicyManager, Handler handler, ActivityStarter activityStarter, BroadcastDispatcher broadcastDispatcher, UiEventLogger uiEventLogger, FalsingManager falsingManager, TelephonyListenerManager telephonyListenerManager, IActivityTaskManager iActivityTaskManager, UserDetailAdapter userDetailAdapter, SecureSettings secureSettings, Executor executor) {
        AnonymousClass6 r10 = new KeyguardStateController.Callback() {
        ...
        if (!this.mPauseRefreshUsers) {
            ...
            new AsyncTask<SparseArray<Bitmap>, Void, ArrayList<UserRecord>>() {
                ...
                public ArrayList<UserRecord> doInBackground(SparseArray<Bitmap>... sparseArrayArr) {
                    ...
                    UserSwitcherController userSwitcherController = UserSwitcherController.this;
                    boolean z = userSwitcherController.mUserManager.getUserSwitchability(UserHandle.of(userSwitcherController.mUserTracker.getUserId())) == 0;
                    UserInfo userInfo = null;
                    for (UserInfo userInfo2 : aliveUsers) {
                        boolean z2 = userId == userInfo2.id;
                        UserInfo userInfo3 = z2 ? userInfo2 : userInfo;
                        boolean z3 = z || z2;
                        if (userInfo2.isEnabled()) {
                            if (userInfo2.isGuest()) {
                                userRecord = new UserRecord(userInfo2, null, true, z2, false, false, z);
                                ...
                                arrayList.add(new UserRecord(userInfo2, bitmap, false, z2, false, false, z3));
                            }
                        }
                        userInfo = userInfo3;
                    }
                    ...
                    boolean z4 = !UserSwitcherController.this.mUserManager.hasBaseUserRestriction("no_add_user", UserHandle.SYSTEM);
                    boolean z5 = userInfo != null && (userInfo.isAdmin() || userInfo.id == 0) && z4;
                    boolean z6 = z4 && z2;
                    boolean z7 = (z5 || z6) && userRecord == null;
                    boolean z8 = (z5 || z6) && UserSwitcherController.this.mUserManager.canAddMoreUsers();
                    boolean z9 = !z2;
                    if (userRecord != null) {
                        arrayList.add(userRecord);
                    } else if (UserSwitcherController.this.mGuestUserAutoCreated) {
                        UserRecord userRecord2 = new UserRecord(null, null, true, false, false, false, !UserSwitcherController.this.mGuestIsResetting.get() && z);
                        UserSwitcherController.this.checkIfAddUserDisallowedByAdminOnly(userRecord2);
                        arrayList.add(userRecord2);
                    } else if (z7) {
                        UserRecord userRecord3 = new UserRecord(null, null, true, false, false, z9, z);
                        UserSwitcherController.this.checkIfAddUserDisallowedByAdminOnly(userRecord3);
                        arrayList.add(userRecord3);
                    }
                    if (z8) {
                        UserRecord userRecord4 = new UserRecord(null, null, false, false, true, z9, z);
