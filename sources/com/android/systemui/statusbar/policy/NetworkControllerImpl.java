...
public class NetworkControllerImpl extends BroadcastReceiver implements NetworkController, DemoMode, DataUsageController.NetworkNameProvider, Dumpable {
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager, TelephonyManager telephonyManager, TelephonyListenerManager telephonyListenerManager, WifiManager wifiManager, NetworkScoreManager networkScoreManager, SubscriptionManager subscriptionManager, MobileMappings.Config config, Looper looper, Executor executor, CallbackHandler callbackHandler, AccessPointControllerImpl accessPointControllerImpl, DataUsageController dataUsageController, MobileStatusTracker.SubscriptionDefaults subscriptionDefaults, final DeviceProvisionedController deviceProvisionedController, BroadcastDispatcher broadcastDispatcher, DemoModeController demoModeController, CarrierConfigTracker carrierConfigTracker, FeatureFlags featureFlags, DumpManager dumpManager) {
        ...
        this.mConfigurationListener = new ConfigurationController.ConfigurationListener() {
            ...
            private /* synthetic */ void lambda$onConfigChanged$0() {
                NetworkControllerImpl.this.handleConfigurationChanged();
            }
        };
        this.mClearForceValidated = new NetworkControllerImpl$$ExternalSyntheticLambda7(this);
        ...
        dataUsageController.setCallback(new DataUsageController.Callback() {
    ...
    public void lambda$new$6() {
        ...
        handler.post(new NetworkControllerImpl$$ExternalSyntheticLambda10(wifiSignalController));
        this.mReceiverHandler.post(new NetworkControllerImpl$$ExternalSyntheticLambda6(this));
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$registerListeners$3() {
    ...
    public boolean isEmergencyOnly() {
        ...
        if (this.mMobileSignalControllers.indexOfKey(defaultVoiceSubId) >= 0) {
            ...
            return ((SignalIcon$MobileState) this.mMobileSignalControllers.get(defaultVoiceSubId).getState()).isEmergency;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (c) {
            ...
            case 6:
                break;
            case 7:
                this.mMainHandler.post(new NetworkControllerImpl$$ExternalSyntheticLambda3(this));
                return;
            default:
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onReceive$4() {
    ...
    private void setUserSetupComplete(boolean z) {
        this.mReceiverHandler.post(new NetworkControllerImpl$$ExternalSyntheticLambda9(this, z));
    }
    ...
    public void dispatchDemoCommand(String str, Bundle bundle) {
        ...
        if (this.mDemoModeController.isInDemoMode()) {
            ...
            if (string9 != null) {
                ...
                ((SignalIcon$MobileState) valueAt2.getState()).dataSim = string10 != null;
                ((SignalIcon$MobileState) valueAt2.getState()).isDefault = string10 != null;
                ((SignalIcon$MobileState) valueAt2.getState()).dataConnected = string10 != null;
                if (string10 != null) {
                    SignalIcon$MobileState signalIcon$MobileState = (SignalIcon$MobileState) valueAt2.getState();
                    ...
                    signalIcon$MobileState.iconGroup = signalIcon$MobileIconGroup;
                }
                if (bundle.containsKey("roam")) {
                    ((SignalIcon$MobileState) valueAt2.getState()).roaming = "show".equals(bundle.getString("roam"));
                }
                String string12 = bundle.getString("level");
                if (string12 != null) {
                    SignalIcon$MobileState signalIcon$MobileState2 = (SignalIcon$MobileState) valueAt2.getState();
                    if (string12.equals("null")) {
                        i = -1;
                    } else {
                        i = Math.min(Integer.parseInt(string12), CellSignalStrength.getNumSignalStrengthLevels());
                    }
                    signalIcon$MobileState2.level = i;
                    ((SignalIcon$MobileState) valueAt2.getState()).connected = ((SignalIcon$MobileState) valueAt2.getState()).level >= 0;
                }
                ...
                if (string13 != null) {
                    ((SignalIcon$MobileState) valueAt2.getState()).dataConnected = true;
                ...
                ((SignalIcon$MobileState) valueAt2.getState()).enabled = equals3;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void recordLastNetworkCallback(String str) {
