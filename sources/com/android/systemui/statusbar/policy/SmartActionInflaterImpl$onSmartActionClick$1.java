...
final class SmartActionInflaterImpl$onSmartActionClick$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        SmartActionInflaterImpl.access$getSmartReplyController$p(this.this$0).smartActionClicked(this.$entry, this.$actionIndex, this.$action, this.$smartActions.fromAssistant);
    }
}
