...
public class KeyguardIndicationTextView extends TextView {
    ...
    private AnimatorSet getOutAnimator() {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.KeyguardIndicationTextView.AnonymousClass1 */
    ...
    private AnimatorSet getInAnimator() {
        ...
        ofFloat2.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.KeyguardIndicationTextView.AnonymousClass2 */
