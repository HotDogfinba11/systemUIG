...
public class KeyguardStatusBarView extends RelativeLayout implements BatteryController.BatteryStateChangeCallback, UserInfoController.OnUserInfoChangedListener, ConfigurationController.ConfigurationListener, SystemStatusAnimationCallback {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mCarrierLabel.setTextSize(0, (float) getResources().getDimensionPixelSize(17105555));
    ...
    private void loadBlockList() {
        Resources resources = getResources();
        this.mBlockedIcons.add(resources.getString(17041460));
        this.mBlockedIcons.add(resources.getString(17041429));
        this.mBlockedIcons.add(resources.getString(17041432));
    }
    ...
    private void updatePadding(Pair<Integer, Integer> pair) {
        ...
        int max = isLayoutRtl() ? Math.max(this.mMinDotWidth, ((Integer) this.mPadding.first).intValue()) : ((Integer) this.mPadding.first).intValue();
        if (isLayoutRtl()) {
            i = ((Integer) this.mPadding.second).intValue();
        } else {
            i = Math.max(this.mMinDotWidth, ((Integer) this.mPadding.second).intValue());
        }
        setPadding(max, i2, i, 0);
    }
