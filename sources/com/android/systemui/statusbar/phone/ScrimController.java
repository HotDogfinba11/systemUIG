...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, Dumpable {
    ...
    public void setQsPosition(float f, int i) {
        if (!Float.isNaN(f)) {
            boolean z = false;
            float notificationScrimAlpha = Interpolators.getNotificationScrimAlpha(f, false);
            boolean z2 = i > 0;
    ...
    private void startScrimAnimation(final View view, float f) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.ScrimController.AnonymousClass3 */
