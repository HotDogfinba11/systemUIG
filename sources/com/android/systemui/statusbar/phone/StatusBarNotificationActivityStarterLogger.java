...
public final class StatusBarNotificationActivityStarterLogger {
    ...
    public final void logStartingActivityFromClick(String str) {
    ...
    public final void logHandleClickAfterKeyguardDismissed(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logHandleClickAfterPanelCollapsed(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logStartNotificationIntent(String str, PendingIntent pendingIntent) {
        Intrinsics.checkNotNullParameter(str, "key");
    ...
    public final void logExpandingBubble(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logNonClickableNotification(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
    ...
    public final void logFullScreenIntentSuppressedByDnD(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logFullScreenIntentNotImportantEnough(String str) {
        Intrinsics.checkNotNullParameter(str, "key");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logSendingFullScreenIntent(String str, PendingIntent pendingIntent) {
        Intrinsics.checkNotNullParameter(str, "key");
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        LogBuffer logBuffer = this.buffer;
        LogLevel logLevel = LogLevel.INFO;
