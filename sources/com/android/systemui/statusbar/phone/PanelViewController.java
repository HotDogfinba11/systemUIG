...
public abstract class PanelViewController {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onFlingEnd(boolean z) {
    ...
    private void startUnlockHintAnimationPhase1(final Runnable runnable) {
        ...
        createHeightAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.PanelViewController.AnonymousClass6 */
            private boolean mCancelled;
    ...
    private void startUnlockHintAnimationPhase2(final Runnable runnable) {
        ...
        createHeightAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.PanelViewController.AnonymousClass7 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void beginJankMonitoring(int i) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void endJankMonitoring(int i) {
        InteractionJankMonitor.getInstance().end(i);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void cancelJankMonitoring(int i) {
