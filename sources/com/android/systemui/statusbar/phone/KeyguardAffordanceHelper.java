...
public class KeyguardAffordanceHelper {
    private Runnable mAnimationEndRunnable = new Runnable() {
        /* class com.android.systemui.statusbar.phone.KeyguardAffordanceHelper.AnonymousClass2 */
    ...
    private void startHintAnimationPhase1(final boolean z, final Runnable runnable) {
        ...
        animatorToRadius.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.KeyguardAffordanceHelper.AnonymousClass3 */
    ...
    private void startUnlockHintAnimationPhase2(boolean z, final Runnable runnable) {
        ...
        animatorToRadius.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.KeyguardAffordanceHelper.AnonymousClass4 */
    ...
    private ValueAnimator getAnimatorToRadius(final boolean z, int i) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.android.systemui.statusbar.phone.KeyguardAffordanceHelper.AnonymousClass5 */
    ...
    private void fling(float f, boolean z, boolean z2) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.android.systemui.statusbar.phone.KeyguardAffordanceHelper.AnonymousClass6 */
