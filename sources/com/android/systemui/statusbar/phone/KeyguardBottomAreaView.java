...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener, KeyguardStateController.Callback, AccessibilityController.AccessibilityStateChangedCallback {
    ...
    public KeyguardBottomAreaView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mListingCallback = new ControlsListingController.ControlsListingCallback() {
            ...
            private /* synthetic */ void lambda$onServicesUpdated$0(List list) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ IntentButtonProvider.IntentButton lambda$onAttachedToWindow$1() {
        return new DefaultRightButton();
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ IntentButtonProvider.IntentButton lambda$onAttachedToWindow$4() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onDetachedFromWindow$6(ControlsListingController controlsListingController) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mIndicationTextBottom.setTextSize(0, (float) getResources().getDimensionPixelSize(17105555));
        this.mIndicationText.setTextSize(0, (float) getResources().getDimensionPixelSize(17105555));
    ...
    private void updateControlsVisibility() {
        ControlsComponent controlsComponent = this.mControlsComponent;
        if (controlsComponent != null) {
            boolean booleanValue = controlsComponent.getControlsController().map(KeyguardBottomAreaView$$ExternalSyntheticLambda8.INSTANCE).orElse((U) Boolean.FALSE).booleanValue();
        ...
        if (!CameraIntents.isSecureCameraIntent(cameraIntent) || wouldLaunchResolverActivity) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    KeyguardBottomAreaView.this.post(new Runnable() {
                        /* class com.android.systemui.statusbar.phone.KeyguardBottomAreaView.AnonymousClass4.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$initControls$8(ControlsListingController controlsListingController) {
