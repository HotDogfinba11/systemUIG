...
public class KeyguardIndicationController {
    ...
    private KeyguardStateController.Callback mKeyguardStateCallback = new KeyguardStateController.Callback() {
        /* class com.android.systemui.statusbar.KeyguardIndicationController.AnonymousClass7 */
    ...
    private StatusBarStateController.StateListener mStatusBarStateListener = new StatusBarStateController.StateListener() {
        /* class com.android.systemui.statusbar.KeyguardIndicationController.AnonymousClass6 */
    ...
    public /* synthetic */ void lambda$init$1(int i) {
        this.mHandler.post(new KeyguardIndicationController$$ExternalSyntheticLambda2(this, i));
    }
    ...
    private void updateDisclosure() {
        if (((Boolean) DejankUtils.whitelistIpcs(new KeyguardIndicationController$$ExternalSyntheticLambda3(this))).booleanValue()) {
    ...
    private void updateUserLocked(int i) {
        if (!this.mKeyguardUpdateMonitor.isUserUnlocked(i)) {
            this.mRotateTextViewController.updateIndication(8, new KeyguardIndication.Builder().setMessage(this.mContext.getResources().getText(17040559)).setTextColor(this.mInitialTextColorState).build(), false);
        } else {
            ...
            public void onAnimationEnd(Animator animator) {
                if (this.mCancelled) {
                    ...
                    keyguardIndicationTextView.animate().setDuration((long) integer3).setInterpolator(Interpolators.BOUNCE).translationY(0.0f).setListener(new AnimatorListenerAdapter() {
                        /* class com.android.systemui.statusbar.KeyguardIndicationController.AnonymousClass3.AnonymousClass1 */
    ...
    public String computePowerIndication() {
        ...
        if (this.mBatteryOverheated) {
            return this.mContext.getResources().getString(R$string.keyguard_plugged_in_charging_limited, NumberFormat.getPercentInstance().format((double) (((float) this.mBatteryLevel) / 100.0f)));
            ...
            if (z) {
                return this.mContext.getResources().getString(i, Formatter.formatShortElapsedTimeRoundingUpToMinutes(this.mContext, this.mChargingTimeRemaining), format);
            }
    ...
    public void showActionToUnlock() {
        ...
        } else if (!this.mStatusBarKeyguardViewManager.isShowingAlternateAuth() && this.mKeyguardUpdateMonitor.isFaceEnrolled()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showTryFingerprintMsg(String str) {
