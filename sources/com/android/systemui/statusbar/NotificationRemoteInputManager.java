...
public class NotificationRemoteInputManager implements Dumpable {
    ...
    public boolean lambda$activateRemoteInput$1(View view, RemoteInput[] remoteInputArr, RemoteInput remoteInput, PendingIntent pendingIntent, NotificationEntry.EditedSuggestionInfo editedSuggestionInfo, String str, AuthBypassPredicate authBypassPredicate) {
        ...
        if (remoteInputView == expandableNotificationRow.getPrivateLayout().getExpandedRemoteInput() && !expandableNotificationRow.getPrivateLayout().getExpandedChild().isShown()) {
            this.mCallback.onMakeExpandedVisibleForRemoteInput(expandableNotificationRow, view, z, new NotificationRemoteInputManager$$ExternalSyntheticLambda2(this, view, remoteInputArr, remoteInput, pendingIntent, editedSuggestionInfo, str, authBypassPredicate));
            return true;
            ...
            if (z) {
                remoteInputView.setBouncerChecker(new NotificationRemoteInputManager$$ExternalSyntheticLambda0(this, authBypassPredicate, view, pendingIntent, expandableNotificationRow));
            }
            return true;
        }
    }
