...
public class DependencyProvider {
    ...
    static ThemeOverlayApplier provideThemeOverlayManager(Context context, Executor executor, Executor executor2, OverlayManager overlayManager, DumpManager dumpManager) {
