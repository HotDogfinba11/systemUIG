...
public final class MediaDataManager$loadMediaDataInBg$1 implements Runnable {
    ...
    public final void run() {
        ...
        mediaDataManager.onMediaDataLoaded(str, str2, new MediaData(this.$sbn.getNormalizedUserId(), true, this.this$0.bgColor, this.$app, this.$smallIcon, this.$artist.element, this.$song.element, this.$artWorkIcon, this.$actionIcons, this.$actionsToShowCollapsed.element, packageName, this.$token, this.$notif.contentIntent, null, active, resumeAction, this.$isLocalSession, false, this.$key, areEqual, this.$isPlaying, this.$sbn.isClearable(), this.$lastActive, 131072, null));
    }
}
