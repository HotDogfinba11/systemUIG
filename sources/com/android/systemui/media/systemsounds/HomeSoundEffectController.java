...
public class HomeSoundEffectController extends SystemUI {
    ...
    public void start() {
        if (this.mAudioManager.isHomeSoundEffectEnabled()) {
            this.mTaskStackChangeListeners.registerTaskStackListener(new TaskStackChangeListener() {
                /* class com.android.systemui.media.systemsounds.HomeSoundEffectController.AnonymousClass1 */
    ...
    private void handleTaskStackChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
