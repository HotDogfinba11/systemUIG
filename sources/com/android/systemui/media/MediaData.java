...
public final class MediaData {
    ...
    public static /* synthetic */ MediaData copy$default(MediaData mediaData, int i, boolean z, int i2, String str, Icon icon, CharSequence charSequence, CharSequence charSequence2, Icon icon2, List list, List list2, String str2, MediaSession.Token token2, PendingIntent pendingIntent, MediaDeviceData mediaDeviceData, boolean z2, Runnable runnable, boolean z3, boolean z4, String str3, boolean z5, Boolean bool, boolean z6, long j, int i3, Object obj) {
        return mediaData.copy((i3 & 1) != 0 ? mediaData.userId : i, (i3 & 2) != 0 ? mediaData.initialized : z, (i3 & 4) != 0 ? mediaData.backgroundColor : i2, (i3 & 8) != 0 ? mediaData.app : str, (i3 & 16) != 0 ? mediaData.appIcon : icon, (i3 & 32) != 0 ? mediaData.artist : charSequence, (i3 & 64) != 0 ? mediaData.song : charSequence2, (i3 & 128) != 0 ? mediaData.artwork : icon2, (i3 & 256) != 0 ? mediaData.actions : list, (i3 & 512) != 0 ? mediaData.actionsToShowInCompact : list2, (i3 & 1024) != 0 ? mediaData.packageName : str2, (i3 & 2048) != 0 ? mediaData.token : token2, (i3 & 4096) != 0 ? mediaData.clickIntent : pendingIntent, (i3 & 8192) != 0 ? mediaData.device : mediaDeviceData, (i3 & 16384) != 0 ? mediaData.active : z2, (i3 & 32768) != 0 ? mediaData.resumeAction : runnable, (i3 & 65536) != 0 ? mediaData.isLocalSession : z3, (i3 & 131072) != 0 ? mediaData.resumption : z4, (i3 & 262144) != 0 ? mediaData.notificationKey : str3, (i3 & 524288) != 0 ? mediaData.hasCheckedForResume : z5, (i3 & 1048576) != 0 ? mediaData.isPlaying : bool, (i3 & 2097152) != 0 ? mediaData.isClearable : z6, (i3 & 4194304) != 0 ? mediaData.lastActive : j);
    }

    public final MediaData copy(int i, boolean z, int i2, String str, Icon icon, CharSequence charSequence, CharSequence charSequence2, Icon icon2, List<MediaAction> list, List<Integer> list2, String str2, MediaSession.Token token2, PendingIntent pendingIntent, MediaDeviceData mediaDeviceData, boolean z2, Runnable runnable, boolean z3, boolean z4, String str3, boolean z5, Boolean bool, boolean z6, long j) {
