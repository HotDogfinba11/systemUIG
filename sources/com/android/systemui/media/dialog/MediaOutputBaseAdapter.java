    ...
    public abstract class MediaDeviceBaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public void initSeekbar(final MediaDevice mediaDevice) {
            ...
            this.mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                /* class com.android.systemui.media.dialog.MediaOutputBaseAdapter.MediaDeviceBaseViewHolder.AnonymousClass1 */
        ...
        public void initSessionSeekbar() {
            ...
            this.mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                /* class com.android.systemui.media.dialog.MediaOutputBaseAdapter.MediaDeviceBaseViewHolder.AnonymousClass2 */
        ...
        public void playSwitchingAnim(final View view, final View view2) {
            ...
            if (seekBar.getVisibility() == 0 && textView.getVisibility() == 0) {
                ...
                textView.animate().setDuration(200).translationY(-dimensionPixelSize).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).setListener(new AnimatorListenerAdapter() {
                    /* class com.android.systemui.media.dialog.MediaOutputBaseAdapter.MediaDeviceBaseViewHolder.AnonymousClass3 */
                ...
                seekBar.animate().alpha(0.0f).setDuration(200).setListener(new AnimatorListenerAdapter() {
                    /* class com.android.systemui.media.dialog.MediaOutputBaseAdapter.MediaDeviceBaseViewHolder.AnonymousClass4 */

                    public void onAnimationEnd(Animator animator) {
                        TextView textView = (TextView) view.requireViewById(R$id.two_line_title);
                        textView.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039944), 0));
                        textView.animate().setDuration(200).translationY(dimensionPixelSize).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).setListener(new AnimatorListenerAdapter() {
                            /* class com.android.systemui.media.dialog.MediaOutputBaseAdapter.MediaDeviceBaseViewHolder.AnonymousClass4.AnonymousClass1 */
