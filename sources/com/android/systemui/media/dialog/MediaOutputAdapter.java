...
public class MediaOutputAdapter extends MediaOutputBaseAdapter {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter, com.android.systemui.media.dialog.MediaOutputBaseAdapter
    ...
    public class MediaDeviceViewHolder extends MediaOutputBaseAdapter.MediaDeviceBaseViewHolder {
        ...
        private /* synthetic */ void lambda$onBind$0(View view) {
            onEndItemClick();
        }
        ...
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$onBind$3(View view) {
            onItemClick(1);
        }

        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$onBind$4(View view) {
            onEndItemClick();
        }
