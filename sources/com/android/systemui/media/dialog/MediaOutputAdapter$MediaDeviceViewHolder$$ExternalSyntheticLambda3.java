...
public final /* synthetic */ class MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda3 implements View.OnClickListener {
    ...
    public /* synthetic */ MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda3(MediaOutputAdapter.MediaDeviceViewHolder mediaDeviceViewHolder, MediaDevice mediaDevice) {
        this.f$0 = mediaDeviceViewHolder;
        this.f$1 = mediaDevice;
    }

    public final void onClick(View view) {
        MediaOutputAdapter.MediaDeviceViewHolder.m128$r8$lambda$dBmIgGQm3aosK4WbWaq0qCCnBQ(this.f$0, this.f$1, view);
    }
}
