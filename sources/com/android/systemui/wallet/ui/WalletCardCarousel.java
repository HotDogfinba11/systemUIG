...
public class WalletCardCarousel extends RecyclerView {
    ...
    private /* synthetic */ void lambda$onViewAdded$0(View view, View view2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        updateCardView(view);
    }
    ...
    private class CarouselSnapHelper extends PagerSnapHelper {
        ...
        public LinearSmoothScroller createScroller(final RecyclerView.LayoutManager layoutManager) {
            return new LinearSmoothScroller(WalletCardCarousel.this.getContext()) {
                /* class com.android.systemui.wallet.ui.WalletCardCarousel.CarouselSnapHelper.AnonymousClass1 */
    ...
    public class WalletCardCarouselAdapter extends RecyclerView.Adapter<WalletCardViewHolder> {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private /* synthetic */ void lambda$onBindViewHolder$0(int i, WalletCardViewInfo walletCardViewInfo, View view) {
            WalletCardCarousel walletCardCarousel = WalletCardCarousel.this;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private boolean setData(List<WalletCardViewInfo> list, boolean z) {
