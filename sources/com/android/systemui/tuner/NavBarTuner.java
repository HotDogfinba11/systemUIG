...
public class NavBarTuner extends TunerPreferenceFragment {
    ...
    public static /* synthetic */ void $r8$lambda$nbDC6NT5LE3qqWPYR4XtIw7EhmM(NavBarTuner navBarTuner, ListPreference listPreference, String str, String str2) {
        navBarTuner.lambda$bindLayout$2(listPreference, str, str2);
    }
    ...
    private /* synthetic */ void lambda$bindLayout$2(ListPreference listPreference, String str, String str2) {
    ...
    private void bindButton(String str, String str2, String str3) {
        ...
        addTunable(new NavBarTuner$$ExternalSyntheticLambda5(this, str2, listPreference, listPreference2, findPreference), str);
        NavBarTuner$$ExternalSyntheticLambda1 navBarTuner$$ExternalSyntheticLambda1 = new NavBarTuner$$ExternalSyntheticLambda1(this, str, listPreference, findPreference, listPreference2);
        ...
        findPreference.setOnPreferenceClickListener(new NavBarTuner$$ExternalSyntheticLambda3(this, findPreference, str, listPreference, listPreference2));
    }

    private /* synthetic */ void lambda$bindButton$5(String str, ListPreference listPreference, ListPreference listPreference2, Preference preference, String str2, String str3) {
        this.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda7(this, str3, str, listPreference, listPreference2, preference));
    }

    private /* synthetic */ void lambda$bindButton$4(String str, String str2, ListPreference listPreference, ListPreference listPreference2, Preference preference) {
        if (str == null) {
            str = str2;
        }
    ...
    private /* synthetic */ boolean lambda$bindButton$7(String str, ListPreference listPreference, Preference preference, ListPreference listPreference2, Preference preference2, Object obj) {
        this.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda6(this, str, listPreference, preference, listPreference2));
        return true;
    }

    private /* synthetic */ void lambda$bindButton$6(String str, ListPreference listPreference, Preference preference, ListPreference listPreference2) {
        setValue(str, listPreference, preference, listPreference2);
        updateSummary(listPreference2);
    }

    /* access modifiers changed from: public */
    private /* synthetic */ boolean lambda$bindButton$9(Preference preference, String str, ListPreference listPreference, ListPreference listPreference2, Preference preference2) {
    ...
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$bindButton$8(EditText editText, Preference preference, String str, ListPreference listPreference, ListPreference listPreference2, DialogInterface dialogInterface, int i) {
        int i2;
        try {
