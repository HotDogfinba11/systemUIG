...
final class ThumbnailBehavior$bind$1 implements Runnable {
    ...
    public final void run() {
        ...
        uiExecutor.execute(new Runnable() {
            /* class com.android.systemui.controls.ui.ThumbnailBehavior$bind$1.AnonymousClass1 */
            ...
            public final void run() {
                ...
                ControlViewHolder.applyRenderInfo$frameworks__base__packages__SystemUI__android_common__SystemUI_core$default(thumbnailBehavior.getCvh(), thumbnailBehavior.getEnabled(), i, false, 4, null);
            }
        });
    }
}
