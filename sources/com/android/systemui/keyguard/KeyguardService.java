...
public class KeyguardService extends Service {
    ...
    private final IKeyguardService.Stub mBinder = new IKeyguardService.Stub() {
        /* class com.android.systemui.keyguard.KeyguardService.AnonymousClass3 */
    ...
    public KeyguardService(KeyguardViewMediator keyguardViewMediator, KeyguardLifecyclesDispatcher keyguardLifecyclesDispatcher) {
        AnonymousClass1 r1 = new IRemoteAnimationRunner.Stub() {
        ...
        AnonymousClass2 r6 = new IRemoteAnimationRunner.Stub() {
            /* class com.android.systemui.keyguard.KeyguardService.AnonymousClass2 */
