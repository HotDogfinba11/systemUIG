...
public class FaceAuthScreenBrightnessController implements Dumpable {
    ...
    public FaceAuthScreenBrightnessController(NotificationShadeWindowController notificationShadeWindowController2, KeyguardUpdateMonitor keyguardUpdateMonitor2, Resources resources2, GlobalSettings globalSettings2, SystemSettings systemSettings2, Handler handler, DumpManager dumpManager2, boolean z) {
                ...
                if (view3 != null) {
                    ...
                    if (view4 != null) {
                        ...
                        if (view5 != null) {
                            ...
                            this.systemSettings.registerContentObserver("screen_brightness_float", new FaceAuthScreenBrightnessController$attach$1(this, this.mainHandler));
