...
public class ThresholdSensorImpl implements ThresholdSensor {
    ...
    public static /* synthetic */ void $r8$lambda$_190uK9rLb4zpkN8EtAU_KFG8yY(boolean z, long j, ThresholdSensor.Listener listener) {
        lambda$alertListenersInternal$0(z, j, listener);
    }
    ...
    private ThresholdSensorImpl(AsyncSensorManager asyncSensorManager, Sensor sensor, Execution execution, float f, float f2, int i) {
        ...
        this.mSensorEventListener = new SensorEventListener() {
            /* class com.android.systemui.util.sensors.ThresholdSensorImpl.AnonymousClass1 */
    ...
    private static /* synthetic */ void lambda$alertListenersInternal$0(boolean z, long j, ThresholdSensor.Listener listener) {
