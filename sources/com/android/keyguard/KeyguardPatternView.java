...
public class KeyguardPatternView extends KeyguardInputView implements AppearAnimationCreator<LockPatternView.CellState> {
    ...
    private /* synthetic */ void lambda$startAppearAnimation$0() {
        enableClipping(true);
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$startDisappearAnimation$1(Runnable runnable) {
        enableClipping(true);
        if (runnable != null) {
            runnable.run();
        }
    ...
    public CharSequence getTitle() {
        return getResources().getString(17040439);
    }
}
