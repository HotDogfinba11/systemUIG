...
public class KeyguardSimPukViewController extends KeyguardPinBasedInputViewController<KeyguardSimPukView> {
    ...
    KeyguardUpdateMonitorCallback mUpdateMonitorCallback = new KeyguardUpdateMonitorCallback() {
        /* class com.android.keyguard.KeyguardSimPukViewController.AnonymousClass1 */
    ...
    /* access modifiers changed from: protected */
    @Override // com.android.systemui.util.ViewController, com.android.keyguard.KeyguardPinBasedInputViewController, com.android.keyguard.KeyguardInputViewController
    ...
    private void showDefaultMessage() {
        ...
        new CheckSimPuk("", "", this.mSubId) {
            /* class com.android.keyguard.KeyguardSimPukViewController.AnonymousClass2 */
    ...
    private void updateSim() {
        ...
        if (this.mCheckSimPukThread == null) {
            AnonymousClass3 r0 = new CheckSimPuk(this.mPukText, this.mPinText, this.mSubId) {
                /* class com.android.keyguard.KeyguardSimPukViewController.AnonymousClass3 */
