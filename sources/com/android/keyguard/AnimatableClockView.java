...
public class AnimatableClockView extends TextView {
    ...
    private /* synthetic */ Unit lambda$onMeasure$0() {
        invalidate();
    ...
    public void animateCharge(DozeStateGetter dozeStateGetter) {
        ...
        if (textAnimator != null && !textAnimator.isRunning()) {
            setTextStyle(dozeStateGetter.isDozing() ? this.mLockScreenWeight : this.mDozingWeight, -1.0f, null, true, 500, (long) this.mChargeAnimationDelay, new AnimatableClockView$$ExternalSyntheticLambda1(this, dozeStateGetter));
        }
    }

    private /* synthetic */ void lambda$animateCharge$1(DozeStateGetter dozeStateGetter) {
    ...
    private /* synthetic */ void lambda$setTextStyle$2(int i, float f, Integer num, long j, long j2, Runnable runnable) {
