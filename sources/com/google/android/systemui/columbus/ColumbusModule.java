...
public abstract class ColumbusModule {
    ...
    public static final Set<Gate> provideColumbusGates(FlagEnabled flagEnabled, KeyguardProximity keyguardProximity, SetupWizard setupWizard, TelephonyActivity telephonyActivity, VrMode vrMode, CameraVisibility cameraVisibility, PowerSaveState powerSaveState, PowerState powerState) {
        return Companion.provideColumbusGates(flagEnabled, keyguardProximity, setupWizard, telephonyActivity, vrMode, cameraVisibility, powerSaveState, powerState);
    }

    public static final Set<Gate> provideColumbusSoftGates(ChargingState chargingState, UsbState usbState, SystemKeyPress systemKeyPress, ScreenTouch screenTouch) {
        return Companion.provideColumbusSoftGates(chargingState, usbState, systemKeyPress, screenTouch);
    }
    ...
    public static final class Companion {
        ...
        public final Set<Gate> provideColumbusGates(FlagEnabled flagEnabled, KeyguardProximity keyguardProximity, SetupWizard setupWizard, TelephonyActivity telephonyActivity, VrMode vrMode, CameraVisibility cameraVisibility, PowerSaveState powerSaveState, PowerState powerState) {
            ...
            return SetsKt__SetsKt.setOf((Object[]) new Gate[]{flagEnabled, keyguardProximity, setupWizard, telephonyActivity, vrMode, cameraVisibility, powerSaveState, powerState});
        }

        public final Set<Gate> provideColumbusSoftGates(ChargingState chargingState, UsbState usbState, SystemKeyPress systemKeyPress, ScreenTouch screenTouch) {
            ...
            return SetsKt__SetsKt.setOf((Object[]) new Gate[]{chargingState, usbState, systemKeyPress, screenTouch});
        }
