...
public class AdaptiveChargingManager {
    ...
    public void queryStatus(final AdaptiveChargingStatusReceiver adaptiveChargingStatusReceiver) {
        final AnonymousClass1 r0 = new IHwBinder.DeathRecipient() {
            /* class com.google.android.systemui.adaptivecharging.AdaptiveChargingManager.AnonymousClass1 */
        ...
        try {
            initHalInterface.getChargingStageAndDeadline(new IGoogleBattery.getChargingStageAndDeadlineCallback() {
                /* class com.google.android.systemui.adaptivecharging.AdaptiveChargingManager.AnonymousClass2 */
