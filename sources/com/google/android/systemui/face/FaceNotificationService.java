...
public class FaceNotificationService {
    ...
    private final KeyguardUpdateMonitorCallback mKeyguardUpdateMonitorCallback = new KeyguardUpdateMonitorCallback() {
        /* class com.google.android.systemui.face.FaceNotificationService.AnonymousClass1 */
    ...
    private void queueReenrollNotification() {
        ...
        this.mHandler.postDelayed(new FaceNotificationService$$ExternalSyntheticLambda0(this, this.mContext.getString(R$string.face_reenroll_notification_title), this.mContext.getString(R$string.face_reenroll_notification_content)), 10000);
    }
