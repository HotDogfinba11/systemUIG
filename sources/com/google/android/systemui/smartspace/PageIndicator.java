...
public class PageIndicator extends LinearLayout {
    ...
    public void setPageOffset(int i, float f) {
        ...
        if (i2 != 0 || i != this.mCurrentPageIndex) {
            if (i < 0 || i >= getChildCount() - 1) {
                Log.w("PageIndicator", "Current dot index invalid. Cannot set current page offset.");
                return;
            }
            ...
            if (imageView == null || imageView2 == null) {
                Log.w("PageIndicator", "Current and next dot missing. Cannot set current page offset.");
                return;
            }
    ...
    private void initializePageIndicators() {
        ...
        getBackground().setTint(ColorUtils.setAlphaComponent(this.mPrimaryColor, Math.round(51.0f)));
