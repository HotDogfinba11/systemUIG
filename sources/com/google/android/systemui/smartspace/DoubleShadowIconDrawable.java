...
public class DoubleShadowIconDrawable extends LayerDrawable {
    ...
    public DoubleShadowIconDrawable(Drawable drawable, Context context, int i, int i2) {
        super(new Drawable[0]);
        generateIconAndShadow(drawable, context, i, i2, context.getResources().getDimensionPixelSize(R$dimen.enhanced_smartspace_icon_size));
    }
    ...
    private void generateIconAndShadow(Drawable drawable, Context context, int i, int i2, int i3) {
        ...
        int i4 = i3 / 2;
        canvas.translate((float) (((-i) / 2) + i4), (float) (((-i2) / 2) + i4));
    ...
    private static Drawable generateShadowDrawable(Bitmap bitmap, Context context) {
        ...
        Canvas canvas = new Canvas(createBitmap);
        float dimensionPixelSize = (float) context.getResources().getDimensionPixelSize(R$dimen.ambient_text_shadow_radius);
        float dimensionPixelSize2 = (float) context.getResources().getDimensionPixelSize(R$dimen.key_text_shadow_radius);
        float dimensionPixelSize3 = (float) context.getResources().getDimensionPixelSize(R$dimen.key_text_shadow_dx);
        float dimensionPixelSize4 = (float) context.getResources().getDimensionPixelSize(R$dimen.key_text_shadow_dy);
        int[] iArr = new int[2];
        ...
        if (dimensionPixelSize2 != 0.0f) {
            ...
            paint2.setAlpha(72);
            canvas.drawBitmap(extractAlpha2, ((float) iArr[0]) + dimensionPixelSize3, ((float) iArr[1]) + dimensionPixelSize4, paint2);
        }
