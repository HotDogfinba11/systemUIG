...
import com.google.android.systemui.columbus.ColumbusModule_ProvideColumbusSoftGatesFactory;
...
public final class DaggerSysUIGoogleGlobalRootComponent implements SysUIGoogleGlobalRootComponent {
    ...
    private DaggerSysUIGoogleGlobalRootComponent(GlobalModule globalModule, Context context2) {
    ...
    public final class SysUIGoogleSysUIComponentImpl implements SysUIGoogleSysUIComponent {
        ...
        private Provider<ColumbusStructuredDataManager> columbusStructuredDataManagerProvider;
        private Provider<ColumbusTargetRequestService> columbusTargetRequestServiceProvider;
        ...
        private Provider<Set<Gate>> namedSetOfGateProvider2;
        ...
        private Provider<Set<Gate>> provideColumbusSoftGatesProvider;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private NotificationSectionsManager notificationSectionsManager() {
        ...
        private void initialize(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.reverseChargingControllerProvider = DoubleCheck.provider(ReverseChargingController_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider, this.provideReverseWirelessChargerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideAlarmManagerProvider, this.provideUsbManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, this.provideBackgroundExecutorProvider, this.bootCompleteCacheImplProvider, this.provideIThermalServiceProvider));
        ...
        private void initialize3(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            Provider<ShadeListBuilder> provider = DoubleCheck.provider(ShadeListBuilder_Factory.create(this.bindSystemClockProvider, this.shadeListBuilderLoggerProvider, this.dumpManagerProvider, this.notificationInteractionTrackerProvider));
            ...
            this.expandableNotificationRowComponentBuilderProvider = new Provider<ExpandableNotificationRowComponent.Builder>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass1 */
            ...
            Provider<LogBuffer> provider4 = DoubleCheck.provider(LogModule_ProvideNotifInteractionLogBufferFactory.create(this.logBufferFactoryProvider));
            this.provideNotifInteractionLogBufferProvider = provider4;
            this.actionClickLoggerProvider = ActionClickLogger_Factory.create(provider4);
            ...
            Provider<LogBuffer> provider5 = DoubleCheck.provider(LogModule_ProvideDozeLogBufferFactory.create(this.logBufferFactoryProvider));
            this.provideDozeLogBufferProvider = provider5;
            DozeLogger_Factory create5 = DozeLogger_Factory.create(provider5);
            this.dozeLoggerProvider = create5;
            Provider<DozeLog> provider6 = DoubleCheck.provider(DozeLog_Factory.create(this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, create5));
            this.dozeLogProvider = provider6;
            this.dozeScrimControllerProvider = DoubleCheck.provider(DozeScrimController_Factory.create(this.dozeParametersProvider, provider6));
            ...
            this.mediaDataFilterProvider = MediaDataFilter_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider, this.mediaResumeListenerProvider, this.notificationLockscreenUserManagerGoogleProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, this.bindSystemClockProvider);
            ...
            Provider<Choreographer> provider7 = DoubleCheck.provider(DependencyProvider_ProvidesChoreographerFactory.create(dependencyProvider));
            this.providesChoreographerProvider = provider7;
            this.notificationShadeDepthControllerProvider = DoubleCheck.provider(NotificationShadeDepthController_Factory.create(this.statusBarStateControllerImplProvider, this.blurUtilsProvider, this.biometricUnlockControllerProvider, this.keyguardStateControllerImplProvider, provider7, DaggerSysUIGoogleGlobalRootComponent.this.provideWallpaperManagerProvider, this.notificationShadeWindowControllerImplProvider, this.dozeParametersProvider, this.dumpManagerProvider));
            ...
            Provider<ToastController> provider8 = DoubleCheck.provider(ToastController_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideConfigurationControllerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideWindowManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, this.navigationModeControllerProvider));
            this.toastControllerProvider = provider8;
            this.screenRecordControllerProvider = DoubleCheck.provider(ScreenRecordController_Factory.create(this.recordingControllerProvider, this.provideHandlerProvider, this.keyguardDismissUtilProvider, this.provideUserTrackerProvider, provider8));
            ...
            this.keyguardStatusViewComponentFactoryProvider = new Provider<KeyguardStatusViewComponent.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass2 */
            ...
            this.keyguardBouncerComponentFactoryProvider = new Provider<KeyguardBouncerComponent.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass3 */
            ...
            Provider<RepeatableExecutor> provider9 = DoubleCheck.provider(SysUIConcurrencyModule_ProvideBackgroundRepeatableExecutorFactory.create(this.provideBackgroundDelayableExecutorProvider));
            this.provideBackgroundRepeatableExecutorProvider = provider9;
            this.seekBarViewModelProvider = SeekBarViewModel_Factory.create(provider9);
        ...
        private void initialize4(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            AnonymousClass4 r1 = new Provider<SectionHeaderControllerSubcomponent.Builder>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass4 */
            ...
            Provider<SectionHeaderControllerSubcomponent> provider = DoubleCheck.provider(NotificationSectionHeadersModule_ProvidesIncomingHeaderSubcomponentFactory.create(r1));
            ...
            AnonymousClass5 r12 = new Provider<InjectionInflationController.ViewInstanceCreator.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass5 */
            ...
            this.notificationShelfComponentBuilderProvider = new Provider<NotificationShelfComponent.Builder>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass6 */
            ...
            this.carrierConfigTrackerProvider = DoubleCheck.provider(CarrierConfigTracker_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider));
            ...
            this.internetDialogControllerProvider = InternetDialogController_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, this.activityStarterDelegateProvider, this.provideAccessPointControllerImplProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideSubcriptionManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideTelephonyManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideWifiManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideConnectivityManagagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, this.providesBroadcastDispatcherProvider, this.keyguardUpdateMonitorProvider, this.globalSettingsImplProvider, this.keyguardStateControllerImplProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideWindowManagerProvider, this.toastFactoryProvider, this.provideBgHandlerProvider, this.carrierConfigTrackerProvider, this.locationControllerImplProvider);
            this.internetDialogFactoryProvider = DoubleCheck.provider(InternetDialogFactory_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.provideBackgroundExecutorProvider, this.internetDialogControllerProvider, DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider));
            this.networkControllerImplProvider = DoubleCheck.provider(NetworkControllerImpl_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideBgLooperProvider, this.provideBackgroundExecutorProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideSubcriptionManagerProvider, this.callbackHandlerProvider, this.deviceProvisionedControllerImplProvider, this.providesBroadcastDispatcherProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideConnectivityManagagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideTelephonyManagerProvider, this.telephonyListenerManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideWifiManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideNetworkScoreManagerProvider, this.provideAccessPointControllerImplProvider, this.provideDemoModeControllerProvider, this.carrierConfigTrackerProvider, this.featureFlagsProvider, this.dumpManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.internetDialogFactoryProvider));
        ...
        private void initialize5(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.provideNotificationLoggerProvider = DoubleCheck.provider(NotificationsModule_ProvideNotificationLoggerFactory.create(this.provideNotificationListenerProvider, this.provideUiBackgroundExecutorProvider, this.provideNotificationEntryManagerProvider, this.statusBarStateControllerImplProvider, this.expansionStateLoggerProvider, provider));
            ...
            this.statusBarComponentBuilderProvider = new Provider<StatusBarComponent.Builder>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass7 */
            ...
            this.rotationLockControllerImplProvider = DoubleCheck.provider(RotationLockControllerImpl_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.secureSettingsImplProvider));
            ...
            PrivacyLogger_Factory create = PrivacyLogger_Factory.create(provider2);
            ...
            Provider<LogBuffer> provider3 = DoubleCheck.provider(SystemUIGoogleModule_ProvideNotifVoiceReplyLogBufferFactory.create(this.logBufferFactoryProvider));
            this.provideNotifVoiceReplyLogBufferProvider = provider3;
            this.notificationVoiceReplyLoggerProvider = DoubleCheck.provider(NotificationVoiceReplyLogger_Factory.create(provider3, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider));
            Provider<NotificationVoiceReplyController> provider4 = DoubleCheck.provider(NotificationVoiceReplyController_Factory.create(this.provideNotificationEntryManagerProvider, this.notificationLockscreenUserManagerGoogleProvider, this.provideNotificationRemoteInputManagerProvider, SystemUIGoogleModule_ProvideVoiceReplyCtaLayoutFactory.create(), SystemUIGoogleModule_ProvideVoiceReplyCtaContainerIdFactory.create(), SystemUIGoogleModule_ProvideVoiceReplyCtaTextIdFactory.create(), SystemUIGoogleModule_ProvideVoiceReplyCtaIconIdFactory.create(), this.lockscreenShadeTransitionControllerProvider, this.notificationShadeWindowControllerImplProvider, this.statusBarKeyguardViewManagerProvider, this.provideStatusBarProvider, this.statusBarStateControllerImplProvider, this.provideHeadsUpManagerPhoneProvider, DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.notificationVoiceReplyLoggerProvider));
            this.notificationVoiceReplyControllerProvider = provider4;
            Provider<DebugNotificationVoiceReplyClient> provider5 = DoubleCheck.provider(DebugNotificationVoiceReplyClient_Factory.create(this.providesBroadcastDispatcherProvider, this.notificationLockscreenUserManagerGoogleProvider, provider4));
            this.debugNotificationVoiceReplyClientProvider = provider5;
            this.provideNotificationVoiceReplyClientProvider = DoubleCheck.provider(VoiceReplyModule_ProvideNotificationVoiceReplyClientFactory.create(provider5));
            ...
            this.mapOfClassOfAndProviderOfActivityProvider = MapProviderFactory.builder(21).put((Object) ControlsProviderSelectorActivity.class, (Provider) this.controlsProviderSelectorActivityProvider).put((Object) ControlsFavoritingActivity.class, (Provider) this.controlsFavoritingActivityProvider).put((Object) ControlsEditingActivity.class, (Provider) this.controlsEditingActivityProvider).put((Object) ControlsRequestDialog.class, (Provider) this.controlsRequestDialogProvider).put((Object) ControlsActivity.class, (Provider) this.controlsActivityProvider).put((Object) WalletActivity.class, (Provider) this.walletActivityProvider).put((Object) TunerActivity.class, (Provider) this.tunerActivityProvider).put((Object) ForegroundServicesDialog.class, (Provider) ForegroundServicesDialog_Factory.create()).put((Object) WorkLockActivity.class, (Provider) this.workLockActivityProvider).put((Object) BrightnessDialog.class, (Provider) this.brightnessDialogProvider).put((Object) ScreenRecordDialog.class, (Provider) this.screenRecordDialogProvider).put((Object) UsbDebuggingActivity.class, (Provider) this.usbDebuggingActivityProvider).put((Object) UsbDebuggingSecondaryUserActivity.class, (Provider) this.usbDebuggingSecondaryUserActivityProvider).put((Object) CreateUserActivity.class, (Provider) this.createUserActivityProvider).put((Object) TvNotificationPanelActivity.class, (Provider) this.tvNotificationPanelActivityProvider).put((Object) PeopleSpaceActivity.class, (Provider) this.peopleSpaceActivityProvider).put((Object) LongScreenshotActivity.class, (Provider) this.longScreenshotActivityProvider).put((Object) LaunchConversationActivity.class, (Provider) this.launchConversationActivityProvider).put((Object) SensorUseStartedActivity.class, (Provider) this.sensorUseStartedActivityProvider).put((Object) TvUnblockSensorActivity.class, (Provider) this.tvUnblockSensorActivityProvider).put((Object) GameMenuActivity.class, (Provider) this.gameMenuActivityProvider).build();
        ...
        private void initialize6(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.scrollCaptureControllerProvider = ScrollCaptureController_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideBackgroundExecutorProvider, this.scrollCaptureClientProvider, this.imageTileSetProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider);
            ScreenshotController_Factory create = ScreenshotController_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.screenshotSmartActionsProvider, this.screenshotNotificationsControllerProvider, this.scrollCaptureClientProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, this.imageExporterProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, this.scrollCaptureControllerProvider, this.longScreenshotDataProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideActivityManagerProvider);
            this.screenshotControllerProvider = create;
            this.takeScreenshotServiceProvider = TakeScreenshotService_Factory.create(create, DaggerSysUIGoogleGlobalRootComponent.this.provideUserManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, this.screenshotNotificationsControllerProvider);
            AnonymousClass8 r1 = new Provider<DozeComponent.Builder>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass8 */
            ...
            this.factoryProvider4 = DoubleCheck.provider(ColumbusContentObserver_Factory_Factory.create(provider4, this.provideUserTrackerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider));
            this.columbusSettingsProvider = DoubleCheck.provider(ColumbusSettings_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideUserTrackerProvider, this.factoryProvider4));
            this.columbusStructuredDataManagerProvider = DoubleCheck.provider(ColumbusStructuredDataManager_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideUserTrackerProvider, this.provideBackgroundExecutorProvider));
            this.columbusTargetRequestServiceProvider = ColumbusTargetRequestService_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideUserTrackerProvider, this.columbusSettingsProvider, this.columbusStructuredDataManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.provideBgLooperProvider);
            this.mapOfClassOfAndProviderOfServiceProvider = MapProviderFactory.builder(9).put((Object) TakeScreenshotService.class, (Provider) this.takeScreenshotServiceProvider).put((Object) DozeService.class, (Provider) this.dozeServiceProvider).put((Object) ImageWallpaper.class, (Provider) ImageWallpaper_Factory.create()).put((Object) KeyguardService.class, (Provider) this.keyguardServiceProvider).put((Object) SystemUIService.class, (Provider) this.systemUIServiceProvider).put((Object) SystemUIAuxiliaryDumpService.class, (Provider) this.systemUIAuxiliaryDumpServiceProvider).put((Object) RecordingService.class, (Provider) this.recordingServiceProvider).put((Object) NotificationVoiceReplyManagerService.class, (Provider) this.notificationVoiceReplyManagerServiceProvider).put((Object) ColumbusTargetRequestService.class, (Provider) this.columbusTargetRequestServiceProvider).build();
            ...
            OpaLockscreen_Factory create2 = OpaLockscreen_Factory.create(this.provideStatusBarProvider, this.keyguardStateControllerImplProvider);
            this.opaLockscreenProvider = create2;
            this.assistInvocationEffectProvider = AssistInvocationEffect_Factory.create(this.assistManagerGoogleProvider, this.opaHomeButtonProvider, create2);
            ...
            Provider<LaunchApp> provider6 = DoubleCheck.provider(LaunchApp_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideLauncherAppsProvider, this.activityStarterDelegateProvider, this.statusBarKeyguardViewManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideIActivityManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUserManagerProvider, this.columbusSettingsProvider, this.keyguardVisibilityProvider, this.keyguardUpdateMonitorProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.provideBgHandlerProvider, this.provideBackgroundExecutorProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider, this.provideUserTrackerProvider));
            ...
            Provider<PowerSaveState> provider9 = DoubleCheck.provider(PowerSaveState_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider));
            this.powerSaveStateProvider = provider9;
            this.provideColumbusGatesProvider = ColumbusModule_ProvideColumbusGatesFactory.create(this.flagEnabledProvider, this.keyguardProximityProvider, this.setupWizardProvider, this.telephonyActivityProvider2, this.vrModeProvider, this.cameraVisibilityProvider, provider9, this.powerStateProvider);
            ...
            this.provideGestureSensorProvider = DoubleCheck.provider(ColumbusModule_ProvideGestureSensorFactory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.columbusSettingsProvider, this.cHREGestureSensorProvider, this.gestureSensorImplProvider));
            ...
            Provider<ScreenTouch> provider12 = DoubleCheck.provider(ScreenTouch_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.powerStateProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider));
            this.screenTouchProvider = provider12;
            this.provideColumbusSoftGatesProvider = ColumbusModule_ProvideColumbusSoftGatesFactory.create(this.chargingStateProvider, this.usbStateProvider, this.systemKeyPressProvider, provider12);
            SetFactory build = SetFactory.builder(0, 1).addCollectionProvider(this.provideColumbusSoftGatesProvider).build();
            this.namedSetOfGateProvider2 = build;
            Provider<GestureController> provider13 = DoubleCheck.provider(GestureController_Factory.create(this.provideGestureSensorProvider, build, this.commandRegistryProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUiEventLoggerProvider));
            ...
            this.columbusServiceWrapperProvider = DoubleCheck.provider(ColumbusServiceWrapper_Factory.create(this.columbusSettingsProvider, provider14, this.settingsActionProvider, this.columbusStructuredDataManagerProvider));
        ...
        private void initialize7(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.provideThemeOverlayManagerProvider = DoubleCheck.provider(DependencyProvider_ProvideThemeOverlayManagerFactory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.provideBackgroundExecutorProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideOverlayManagerProvider, this.dumpManagerProvider));
            this.themeOverlayControllerGoogleProvider = DoubleCheck.provider(ThemeOverlayControllerGoogle_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider, this.provideBgHandlerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, this.provideBackgroundExecutorProvider, this.provideThemeOverlayManagerProvider, this.secureSettingsImplProvider, this.systemPropertiesHelperProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideResourcesProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideWallpaperManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideUserManagerProvider, this.dumpManagerProvider, this.deviceProvisionedControllerImplProvider, this.provideUserTrackerProvider, this.featureFlagsProvider, this.wakefulnessLifecycleProvider, this.provideConfigurationControllerProvider));
            ...
            this.mapOfClassOfAndProviderOfSystemUIProvider = MapProviderFactory.builder(21).put((Object) AuthController.class, (Provider) this.authControllerProvider).put((Object) GarbageMonitor.Service.class, (Provider) this.serviceProvider).put((Object) GlobalActionsComponent.class, (Provider) this.globalActionsComponentProvider).put((Object) GoogleServices.class, (Provider) this.googleServicesProvider).put((Object) InstantAppNotifier.class, (Provider) this.instantAppNotifierProvider).put((Object) KeyguardViewMediator.class, (Provider) this.newKeyguardViewMediatorProvider).put((Object) LatencyTester.class, (Provider) this.latencyTesterProvider).put((Object) PowerUI.class, (Provider) this.powerUIProvider).put((Object) Recents.class, (Provider) this.provideRecentsProvider).put((Object) ScreenDecorations.class, (Provider) this.screenDecorationsProvider).put((Object) ShortcutKeyDispatcher.class, (Provider) this.shortcutKeyDispatcherProvider).put((Object) SliceBroadcastRelayHandler.class, (Provider) this.sliceBroadcastRelayHandlerProvider).put((Object) StatusBar.class, (Provider) this.provideStatusBarProvider).put((Object) SystemActions.class, (Provider) this.systemActionsProvider).put((Object) StatusBarGoogle.class, (Provider) this.provideStatusBarProvider).put((Object) ThemeOverlayController.class, (Provider) this.themeOverlayControllerGoogleProvider).put((Object) ToastUI.class, (Provider) this.toastUIProvider).put((Object) TvStatusBar.class, (Provider) this.tvStatusBarProvider).put((Object) VolumeUI.class, (Provider) this.volumeUIProvider).put((Object) WindowMagnification.class, (Provider) this.windowMagnificationProvider).put((Object) WMShell.class, (Provider) this.wMShellProvider).build();
            ...
            AnonymousClass9 r1 = new Provider<FragmentService.FragmentCreator.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass9 */
            ...
            this.keyguardQsUserSwitchComponentFactoryProvider = new Provider<KeyguardQsUserSwitchComponent.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass10 */
            ...
            this.keyguardUserSwitcherComponentFactoryProvider = new Provider<KeyguardUserSwitcherComponent.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass11 */
            ...
            this.keyguardStatusBarViewComponentFactoryProvider = new Provider<KeyguardStatusBarViewComponent.Factory>() {
                /* class com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent.SysUIGoogleSysUIComponentImpl.AnonymousClass12 */
            ...
            this.rotationLockTileProvider = RotationLockTile_Factory.create(this.qSTileHostProvider, this.provideBgLooperProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider, this.rotationLockControllerImplProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideSensorPrivacyManagerProvider, this.provideBatteryControllerProvider, this.secureSettingsImplProvider);
            ...
            Provider<Boolean> provider4 = DoubleCheck.provider(QSFlagsModule_IsReduceBrightColorsAvailableFactory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider));
            this.isReduceBrightColorsAvailableProvider = provider4;
            this.reduceBrightColorsTileProvider = ReduceBrightColorsTile_Factory.create(provider4, this.provideReduceBrightColorsListenerProvider, this.qSTileHostProvider, this.provideBgLooperProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider);
            ...
            this.builderProvider12 = DoubleCheck.provider(AutoAddTracker_Builder_Factory.create(this.secureSettingsImplProvider, this.providesBroadcastDispatcherProvider, this.qSTileHostProvider, this.dumpManagerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainHandlerProvider, this.provideBackgroundExecutorProvider));
        ...
        private final class StatusBarComponentImpl implements StatusBarComponent {
            ...
            private void initialize(NotificationShadeWindowView notificationShadeWindowView) {
                ...
                this.tapAgainViewControllerProvider = DoubleCheck.provider(TapAgainViewController_Factory.create(provider, SysUIGoogleSysUIComponentImpl.this.provideMainDelayableExecutorProvider, SysUIGoogleSysUIComponentImpl.this.provideConfigurationControllerProvider, FalsingModule_ProvidesDoubleTapTimeoutMsFactory.create()));
        ...
        private final class KeyguardQsUserSwitchComponentImpl implements KeyguardQsUserSwitchComponent {
            private Provider<FrameLayout> arg0Provider;
        ...
        private final class QSFragmentComponentImpl implements QSFragmentComponent {
            ...
            private void initialize(QSFragment qSFragment) {
                ...
                this.tileQueryHelperProvider = DoubleCheck.provider(TileQueryHelper_Factory.create(DaggerSysUIGoogleGlobalRootComponent.this.contextProvider, SysUIGoogleSysUIComponentImpl.this.provideUserTrackerProvider, DaggerSysUIGoogleGlobalRootComponent.this.provideMainExecutorProvider, SysUIGoogleSysUIComponentImpl.this.provideBackgroundExecutorProvider, SysUIGoogleSysUIComponentImpl.this.featureFlagsProvider));
