...
public final class SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory implements Factory<HeadsUpManagerPhone> {
    ...
    public SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory(Provider<Context> provider, Provider<StatusBarStateController> provider2, Provider<KeyguardBypassController> provider3, Provider<GroupMembershipManager> provider4, Provider<ConfigurationController> provider5) {
    ...
    public static SystemUIGoogleModule_ProvideHeadsUpManagerPhoneFactory create(Provider<Context> provider, Provider<StatusBarStateController> provider2, Provider<KeyguardBypassController> provider3, Provider<GroupMembershipManager> provider4, Provider<ConfigurationController> provider5) {
    ...
    public static HeadsUpManagerPhone provideHeadsUpManagerPhone(Context context, StatusBarStateController statusBarStateController, KeyguardBypassController keyguardBypassController, GroupMembershipManager groupMembershipManager, ConfigurationController configurationController) {
        return (HeadsUpManagerPhone) Preconditions.checkNotNullFromProvides(SystemUIGoogleModule.provideHeadsUpManagerPhone(context, statusBarStateController, keyguardBypassController, groupMembershipManager, configurationController));
    }
}
