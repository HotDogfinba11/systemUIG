...
public class ReverseChargingTile extends QSTileImpl<QSTile.BooleanState> implements BatteryController.BatteryStateChangeCallback {
    ...
    private final ContentObserver mSettingsObserver = new ContentObserver(this.mHandler) {
        /* class com.google.android.systemui.qs.tiles.ReverseChargingTile.AnonymousClass2 */
    ...
    private final IThermalEventListener mThermalEventListener = new IThermalEventListener.Stub() {
        /* class com.google.android.systemui.qs.tiles.ReverseChargingTile.AnonymousClass1 */
