...
public class ElmyraService implements Dumpable {
    private final Action.Listener mActionListener = new Action.Listener() {
        /* class com.google.android.systemui.elmyra.ElmyraService.AnonymousClass1 */
    ...
    private final Gate.Listener mGateListener = new Gate.Listener() {
        /* class com.google.android.systemui.elmyra.ElmyraService.AnonymousClass2 */
    ...
    public ElmyraService(Context context, ServiceConfiguration serviceConfiguration, UiEventLogger uiEventLogger) {
        ...
        arrayList.forEach(new ElmyraService$$ExternalSyntheticLambda0(this));
        ...
        arrayList2.forEach(new ElmyraService$$ExternalSyntheticLambda1(this));
