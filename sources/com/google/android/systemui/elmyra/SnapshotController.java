...
public final class SnapshotController implements GestureSensor.Listener {
    private final Handler mHandler = new Handler(Looper.getMainLooper()) {
        /* class com.google.android.systemui.elmyra.SnapshotController.AnonymousClass1 */
    ...
    private void requestSnapshot(SnapshotProtos$SnapshotHeader snapshotProtos$SnapshotHeader) {
