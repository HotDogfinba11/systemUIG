...
public class JNIGestureSensor implements GestureSensor {
    ...
    public JNIGestureSensor(Context context, GestureConfiguration gestureConfiguration) {
        AnonymousClass1 r2 = new KeyguardUpdateMonitorCallback() {
            /* class com.google.android.systemui.elmyra.sensors.JNIGestureSensor.AnonymousClass1 */
        ...
        gestureConfiguration.setListener(new JNIGestureSensor$$ExternalSyntheticLambda0(this));
