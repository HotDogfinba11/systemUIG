...
public class SetupWizardAction extends Action {
    ...
    private SetupWizardAction(Context context, SettingsAction settingsAction, LaunchOpa launchOpa, StatusBar statusBar) {
        ...
        AnonymousClass1 r0 = new KeyguardUpdateMonitorCallback() {
            /* class com.google.android.systemui.elmyra.actions.SetupWizardAction.AnonymousClass1 */
        ...
        AnonymousClass2 r1 = new Gate.Listener() {
            /* class com.google.android.systemui.elmyra.actions.SetupWizardAction.AnonymousClass2 */
