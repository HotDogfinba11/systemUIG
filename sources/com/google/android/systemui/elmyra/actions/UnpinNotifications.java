...
public class UnpinNotifications extends Action {
    ...
    private final OnHeadsUpChangedListener mHeadsUpChangedListener = new OnHeadsUpChangedListener() {
        /* class com.google.android.systemui.elmyra.actions.UnpinNotifications.AnonymousClass1 */
    ...
    public UnpinNotifications(Context context, Optional<HeadsUpManager> optional) {
        ...
        if (optional.isPresent()) {
            ...
            this.mSettingsObserver = new UserContentObserver(getContext(), Settings.Secure.getUriFor("assist_gesture_silence_alerts_enabled"), new UnpinNotifications$$ExternalSyntheticLambda0(this));
            return;
        }
