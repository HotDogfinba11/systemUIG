...
public class LaunchOpa extends Action implements TunerService.Tunable {
    ...
    private LaunchOpa(Context context, StatusBar statusBar, List<FeedbackEffect> list) {
        ...
        AnonymousClass1 r4 = new OpaEnabledListener() {
            /* class com.google.android.systemui.elmyra.actions.LaunchOpa.AnonymousClass1 */
        ...
        this.mSettingsObserver = new UserContentObserver(getContext(), Settings.Secure.getUriFor("assist_gesture_enabled"), new LaunchOpa$$ExternalSyntheticLambda0(this));
