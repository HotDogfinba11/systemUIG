...
public class CameraVisibility extends Gate {
    ...
    private final TaskStackListener mTaskStackListener = new TaskStackListener() {
        /* class com.google.android.systemui.elmyra.gates.CameraVisibility.AnonymousClass1 */
    ...
    public CameraVisibility(Context context, CameraAction cameraAction, List<Action> list) {
        ...
        AnonymousClass2 r0 = new Gate.Listener() {
            /* class com.google.android.systemui.elmyra.gates.CameraVisibility.AnonymousClass2 */
