...
public class LiveWallpaperScrimController extends ScrimController {
    ...
    private boolean isReducedScrimWallpaperSet() {
        return ((Boolean) DejankUtils.whitelistIpcs(new LiveWallpaperScrimController$$ExternalSyntheticLambda0(this))).booleanValue();
    }

    /* access modifiers changed from: public */
    private /* synthetic */ Boolean lambda$isReducedScrimWallpaperSet$0() {
        try {
