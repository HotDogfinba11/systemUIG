...
public class AutorotateDataService {
    ...
    private final BroadcastReceiver mScreenEventBroadcastReceiver = new BroadcastReceiver() {
        /* class com.google.android.systemui.autorotate.AutorotateDataService.AnonymousClass1 */
    ...
    public void init() {
        ...
        this.mDeviceConfig.addOnPropertiesChangedListener("window_manager", this.mMainExecutor, new AutorotateDataService$$ExternalSyntheticLambda0(this));
    }
    ...
    private void registerRequiredSensors() {
