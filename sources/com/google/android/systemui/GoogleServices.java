...
public class GoogleServices extends VendorServices {
    ...
    public GoogleServices(Context context, Lazy<ServiceConfigurationGoogle> lazy, StatusBar statusBar, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazy2, AlarmManager alarmManager, AutorotateDataService autorotateDataService) {
        super(context);
    ...
    @Override // com.android.systemui.SystemUI, com.android.systemui.VendorServices
    public void start() {
        ...
        addService(new AmbientIndicationService(this.mContext, ambientIndicationContainer, this.mAlarmManager));
