...
public final class NotificationVoiceReplyManagerKt$awaitStateChange$2$cb$1 implements StatusBarWindowCallback {
    ...
    NotificationVoiceReplyManagerKt$awaitStateChange$2$cb$1(AtomicBoolean atomicBoolean, NotificationShadeWindowController notificationShadeWindowController, CancellableContinuation<? super StatusBarWindowState> cancellableContinuation) {
    ...
    public void onStateChanged(boolean z, boolean z2, boolean z3) {
        ...
        if (atomicBoolean.getAndSet(false)) {
            ...
            cancellableContinuation.resumeWith(Result.m699constructorimpl(statusBarWindowState));
        }
    }
}
