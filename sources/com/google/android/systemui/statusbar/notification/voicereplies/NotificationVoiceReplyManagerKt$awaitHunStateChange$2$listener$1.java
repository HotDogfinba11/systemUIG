...
public final class NotificationVoiceReplyManagerKt$awaitHunStateChange$2$listener$1 implements OnHeadsUpChangedListener {
    ...
    NotificationVoiceReplyManagerKt$awaitHunStateChange$2$listener$1(AtomicBoolean atomicBoolean, HeadsUpManager headsUpManager, CancellableContinuation<? super Pair<NotificationEntry, Boolean>> cancellableContinuation) {
    ...
    public void onHeadsUpStateChanged(NotificationEntry notificationEntry, boolean z) {
        ...
        if (atomicBoolean.getAndSet(false)) {
            ...
            cancellableContinuation.resumeWith(Result.m699constructorimpl(pair));
        }
    }
}
