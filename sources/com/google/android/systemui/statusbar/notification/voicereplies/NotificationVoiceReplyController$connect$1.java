...
public final class NotificationVoiceReplyController$connect$1 implements NotificationVoiceReplyManager, Job {
    ...
    NotificationVoiceReplyController$connect$1(Job job, NotificationVoiceReplyController notificationVoiceReplyController, NotificationVoiceReplyController.Connection connection) {
        this.$job = job;
    ...
    public VoiceReplySubscription registerHandler(NotificationVoiceReplyHandler notificationVoiceReplyHandler) {
        ...
        ensureConnected();
        return new NotificationVoiceReplyController$connect$1$registerHandler$1(this.this$0.registerHandler(this.$connection, notificationVoiceReplyHandler), this, this.this$0, this.$connection, notificationVoiceReplyHandler);
    }
