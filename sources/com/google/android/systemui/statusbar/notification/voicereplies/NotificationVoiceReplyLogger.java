...
public final class NotificationVoiceReplyLogger {
    ...
    public final void logReinflation(String str, String str2) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logReinflation$2);
            obtain.setStr1(str);
            obtain.setStr2(str2);
    ...
    public final void logReinflationDropped(String str, String str2) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logReinflationDropped$2);
            obtain.setStr1(str);
            obtain.setStr2(str2);
            logBuffer2.push(obtain);
        }
    ...
    public final void logStateNoCandidate() {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logStateNoCandidate$2);
    ...
    public final void logUserIdMismatch(int i, int i2) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logUserIdMismatch$2);
            obtain.setInt1(i);
            obtain.setInt2(i2);
            logBuffer2.push(obtain);
        }
    ...
    public final void logStateInSession(String str) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logStateInSession$2);
            obtain.setStr1(str);
            logBuffer2.push(obtain);
        }
    }
    ...
    public final void logSessionAlreadyInProgress(int i) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logSessionAlreadyInProgress$2);
            obtain.setInt1(i);
            logBuffer2.push(obtain);
        }
    }
    ...
    public final void logStartSessionNoCandidate(int i) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logStartSessionNoCandidate$2);
            obtain.setInt1(i);
            logBuffer2.push(obtain);
        }
    }
    ...
    public final void logCandidateUserChange(int i, boolean z) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logCandidateUserChange$2);
            obtain.setInt1(i);
    ...
    public final void logBadNotifState() {
        ...
        LogBuffer logBuffer2 = getLogBuffer();
        LogLevel logLevel = LogLevel.DEBUG;
    ...
    public final void logBadWindowState(StatusBarWindowState statusBarWindowState) {
        ...
        if (!logBuffer2.getFrozen()) {
            LogMessageImpl obtain = logBuffer2.obtain("NotifVoiceReply", logLevel, notificationVoiceReplyLogger$logBadWindowState$2);
