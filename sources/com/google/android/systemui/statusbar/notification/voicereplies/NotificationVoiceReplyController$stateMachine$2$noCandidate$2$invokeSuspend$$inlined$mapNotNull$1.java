...
public final class NotificationVoiceReplyController$stateMachine$2$noCandidate$2$invokeSuspend$$inlined$mapNotNull$1 implements Flow<VoiceReplyTarget> {
    ...
    public Object collect(final FlowCollector<? super VoiceReplyTarget> flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowCollector<NotificationEntry>() {
            /* class com.google.android.systemui.statusbar.notification.voicereplies.NotificationVoiceReplyController$stateMachine$2$noCandidate$2$invokeSuspend$$inlined$mapNotNull$1.AnonymousClass2 */
            ...
            public Object emit(NotificationEntry notificationEntry, Continuation continuation) {
                ...
                Object emit = flowCollector.emit(extractCandidate$default, continuation);
