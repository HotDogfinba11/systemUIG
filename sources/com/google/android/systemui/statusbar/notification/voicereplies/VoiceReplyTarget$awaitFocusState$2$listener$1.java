...
public final class VoiceReplyTarget$awaitFocusState$2$listener$1 implements View.OnFocusChangeListener {
    ...
    VoiceReplyTarget$awaitFocusState$2$listener$1(boolean z, AtomicBoolean atomicBoolean, RemoteInputView remoteInputView, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$expected = z;
    ...
    public void onFocusChange(View view, boolean z) {
        ...
        if (z == this.$expected) {
            ...
            if (atomicBoolean.getAndSet(false)) {
                ...
                cancellableContinuation.resumeWith(Result.m699constructorimpl(unit));
            }
        }
    }
}
