...
public final class NotificationVoiceReplyManagerServiceKt$startingWith$1$1 extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    NotificationVoiceReplyManagerServiceKt$startingWith$1$1(T t, Flow<? extends T> flow, Continuation<? super NotificationVoiceReplyManagerServiceKt$startingWith$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        NotificationVoiceReplyManagerServiceKt$startingWith$1$1$invokeSuspend$$inlined$collect$1 notificationVoiceReplyManagerServiceKt$startingWith$1$1$invokeSuspend$$inlined$collect$1 = new NotificationVoiceReplyManagerServiceKt$startingWith$1$1$invokeSuspend$$inlined$collect$1(this.p$);
        this.label = 2;
