...
public final class NotificationVoiceReplyManagerService$binder$1$enableCallbacks$2$invokeSuspend$$inlined$filter$1 implements Flow<Pair<? extends Integer, ? extends Integer>> {
    ...
    public Object collect(final FlowCollector<? super Pair<? extends Integer, ? extends Integer>> flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowCollector<Pair<? extends Integer, ? extends Integer>>() {
            /* class com.google.android.systemui.statusbar.NotificationVoiceReplyManagerService$binder$1$enableCallbacks$2$invokeSuspend$$inlined$filter$1.AnonymousClass2 */
            ...
            public Object emit(Pair<? extends Integer, ? extends Integer> pair, Continuation continuation) {
                ...
                if (!Boxing.boxBoolean(((Number) pair2.getFirst()).intValue() == this.this$0.getUserId() && ((Number) pair2.getSecond()).intValue() != 0).booleanValue()) {
