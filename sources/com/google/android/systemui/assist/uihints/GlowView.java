...
public final class GlowView extends FrameLayout {
    ...
    /* renamed from: $r8$lambda$5m90GCvBsxectjDnv7-V3tvtDC0 */
    public static /* synthetic */ void m643$r8$lambda$5m90GCvBsxectjDnv7V3tvtDC0(GlowView glowView, BlurProvider.BlurResult blurResult, ImageView imageView) {
        glowView.lambda$setBlurredImageOnViews$0(blurResult, imageView);
    }
    ...
    private void setBlurredImageOnViews(int i) {
        ...
        this.mGlowImageViews.forEach(new GlowView$$ExternalSyntheticLambda2(this, blurResult));
    }

    private /* synthetic */ void lambda$setBlurredImageOnViews$0(BlurProvider.BlurResult blurResult, ImageView imageView) {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        post(new GlowView$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onSizeChanged$2() {
        updateGlowSizes();
        post(new GlowView$$ExternalSyntheticLambda1(this));
    }

    /* access modifiers changed from: public */
    private /* synthetic */ void lambda$onSizeChanged$1() {
