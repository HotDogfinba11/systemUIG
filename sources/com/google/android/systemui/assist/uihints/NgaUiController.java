...
public class NgaUiController implements AssistManager.UiController, ViewTreeObserver.OnComputeInternalInsetsListener, StatusBarStateController.StateListener {
    ...
    public NgaUiController(Context context, TimeoutManager timeoutManager, AssistantPresenceHandler assistantPresenceHandler, TouchInsideHandler touchInsideHandler, ColorChangeHandler colorChangeHandler, OverlayUiHost overlayUiHost, EdgeLightsController edgeLightsController, GlowController glowController, ScrimController scrimController, TranscriptionController transcriptionController, IconController iconController, LightnessProvider lightnessProvider, StatusBarStateController statusBarStateController, Lazy<AssistManager> lazy, FlingVelocityWrapper flingVelocityWrapper, AssistantWarmer assistantWarmer, NavBarFader navBarFader, AssistLogger assistLogger) {
        ...
        lightnessProvider.setListener(new NgaUiController$$ExternalSyntheticLambda2(this));
        assistantPresenceHandler.registerSysUiIsNgaUiChangeListener(new NgaUiController$$ExternalSyntheticLambda1(this));
        touchInsideHandler.setFallback(new NgaUiController$$ExternalSyntheticLambda6(this));
        edgeLightsController.setModeChangeThrottler(new NgaUiController$$ExternalSyntheticLambda5(this));
        ...
        refresh();
        timeoutManager.setTimeoutCallback(new NgaUiController$$ExternalSyntheticLambda3(new NgaUiController$$ExternalSyntheticLambda7(this)));
    }
    ...
    private void completeInvocation(int i) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(approximateInverse(Float.valueOf(getAnimationProgress(i, this.mLastInvocationProgress)), new NgaUiController$$ExternalSyntheticLambda13(overshootInterpolator)), 1.0f);
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.uihints.NgaUiController.AnonymousClass1 */
    ...
    public void onComputeInternalInsets(ViewTreeObserver.InternalInsetsInfo internalInsetsInfo) {
        ...
        this.mIconController.getTouchActionRegion().ifPresent(new NgaUiController$$ExternalSyntheticLambda10(region));
        ...
        if (!((mode instanceof FullListening) && ((FullListening) mode).isFakeForHalfListening())) {
            this.mGlowController.getTouchInsideRegion().ifPresent(new NgaUiController$$ExternalSyntheticLambda12(region2));
        }
        this.mScrimController.getTouchInsideRegion().ifPresent(new NgaUiController$$ExternalSyntheticLambda9(region2));
        NgaUiController$$ExternalSyntheticLambda11 ngaUiController$$ExternalSyntheticLambda11 = new NgaUiController$$ExternalSyntheticLambda11(region2);
    ...
    public void lambda$onDozingChanged$11(boolean z) {
        if (Looper.myLooper() != this.mUiHandler.getLooper()) {
            this.mUiHandler.post(new NgaUiController$$ExternalSyntheticLambda8(this, z));
            return;
        }
