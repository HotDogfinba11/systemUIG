...
public class EdgeLightsView extends View {
    ...
    public void setAssistLights(EdgeLight[] edgeLightArr) {
        post(new EdgeLightsView$$ExternalSyntheticLambda0(this, edgeLightArr));
    }
    ...
    public /* synthetic */ void lambda$setAssistLights$1(EdgeLight[] edgeLightArr) {
        ...
        this.mListeners.forEach(new EdgeLightsView$$ExternalSyntheticLambda1(this));
        invalidate();
    }
    ...
    public void commitModeTransition(Mode mode) {
        ...
        this.mMode = mode;
        this.mListeners.forEach(new EdgeLightsView$$ExternalSyntheticLambda2(this));
