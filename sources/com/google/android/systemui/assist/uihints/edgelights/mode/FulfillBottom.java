...
public final class FulfillBottom implements EdgeLightsView.Mode {
    ...
    private void animateCradle() {
        ...
        ofFloat.addUpdateListener(new FulfillBottom$$ExternalSyntheticLambda2(this, this.mBlueLight.getEnd() / regionWidth, this.mRedLight.getEnd() / regionWidth, this.mYellowLight.getEnd() / regionWidth));
    ...
    private void animateExit() {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.uihints.edgelights.mode.FulfillBottom.AnonymousClass1 */
    ...
    private ValueAnimator createFadeOutAnimator() {
        ...
        ofFloat.setDuration(350L);
        ofFloat.addUpdateListener(new FulfillBottom$$ExternalSyntheticLambda1(this));
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.uihints.edgelights.mode.FulfillBottom.AnonymousClass2 */
