...
public class OpaLayout extends FrameLayout implements ButtonInterface, FeedbackEffect {
    ...
    /* renamed from: $r8$lambda$DEu070lpdkATNDJTv0D3bf-IGzA  reason: not valid java name */
    public static /* synthetic */ boolean m639$r8$lambda$DEu070lpdkATNDJTv0D3bfIGzA(OpaLayout opaLayout, View.OnLongClickListener onLongClickListener, View view) {
        return opaLayout.lambda$setOnLongClickListener$0(onLongClickListener, view);
    }

    public static /* synthetic */ void $r8$lambda$Q8QBVI4FXMHQDrYPEPDOfgbzoP8(OpaLayout opaLayout) {
        opaLayout.lambda$new$1();
    }
    ...
    public OpaLayout(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mRetract = new Runnable() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass1 */
        ...
        this.mOverviewProxyListener = new OverviewProxyService.OverviewProxyListener() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass2 */
        ...
        this.mDiamondAnimation = new OpaLayout$$ExternalSyntheticLambda2(this);
    }
    ...
    private /* synthetic */ boolean lambda$setOnLongClickListener$0(View.OnLongClickListener onLongClickListener, View view) {
    ...
    public void onAttachedToWindow() {
        ...
        post(new OpaLayout$$ExternalSyntheticLambda1(this));
    }
    ...
    private ArraySet<Animator> getDiamondAnimatorSet() {
        ...
        getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass3 */
    ...
    private ArraySet<Animator> getRetractAnimatorSet() {
        ...
        getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass4 */
    ...
    private ArraySet<Animator> getCollapseAnimatorSet() {
        ...
        getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass5 */
    ...
    private ArraySet<Animator> getLineAnimatorSet() {
        ...
        getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass6 */
    ...
    private AnimatorSet getGestureAnimatorSet() {
        ...
        if (this.mIsVertical) {
            ...
            translationObjectAnimatorY.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass7 */
            ...
            translationObjectAnimatorX.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.systemui.assist.OpaLayout.AnonymousClass8 */
