...
public class LockscreenOpaLayout extends FrameLayout implements FeedbackEffect {
    ...
    private void startCannedAnimation() {
        if (isAttachedToWindow()) {
            ...
            cannedAnimatorSet.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass1 */
    ...
    private ArraySet<Animator> getRetractAnimatorSet() {
        ...
        OpaUtils.getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass2 */
    ...
    private ArraySet<Animator> getCollapseAnimatorSet() {
        ...
        OpaUtils.getLongestAnim(arraySet).addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass3 */
            ...
            if (i == 3) {
                if (this.mGestureAnimatorSet.isRunning()) {
                    ...
                    this.mGestureAnimatorSet.addListener(new AnimatorListenerAdapter() {
                        /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass4 */
    ...
    public void onResolve(GestureSensor.DetectionProperties detectionProperties) {
        ...
        if (i != 4 && i != 2) {
            if (i == 3) {
                ...
                this.mGestureAnimatorSet.removeAllListeners();
                this.mGestureAnimatorSet.addListener(new AnimatorListenerAdapter() {
                    /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass5 */
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        LockscreenOpaLayout.this.mGestureAnimatorSet.addListener(new AnimatorListenerAdapter() {
                            /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass5.AnonymousClass1 */
            ...
            if (animatorSet != null) {
                ...
                animatorSet.removeAllListeners();
                this.mGestureAnimatorSet.addListener(new AnimatorListenerAdapter() {
                    /* class com.google.android.systemui.assist.LockscreenOpaLayout.AnonymousClass6 */
