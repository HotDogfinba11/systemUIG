...
public class ReverseChargingController extends BroadcastReceiver implements CallbackController<ReverseChargingChangeCallback> {
    ...
    private final AlarmManager.OnAlarmListener mAccessoryDeviceRemovedTimeoutAlarmAction = new ReverseChargingController$$ExternalSyntheticLambda3(this);
    ...
    final BatteryController.BatteryStateChangeCallback mBatteryStateChangeCallback = new BatteryController.BatteryStateChangeCallback() {
        /* class com.google.android.systemui.reversecharging.ReverseChargingController.AnonymousClass1 */
    ...
    private final BootCompleteCache.BootCompleteListener mBootCompleteListener = new ReverseChargingController$$ExternalSyntheticLambda5(this);
    ...
    private final AlarmManager.OnAlarmListener mCheckNfcConflictWithUsbAudioAlarmAction = new ReverseChargingController$$ExternalSyntheticLambda2(this);
    ...
    private final AlarmManager.OnAlarmListener mReconnectedTimeoutAlarmAction = new ReverseChargingController$$ExternalSyntheticLambda1(this);
    ...
    private final AlarmManager.OnAlarmListener mRtxFinishAlarmAction = new ReverseChargingController$$ExternalSyntheticLambda0(this);
    private final AlarmManager.OnAlarmListener mRtxFinishRxFullAlarmAction = new ReverseChargingController$$ExternalSyntheticLambda4(this);
    ...
    public void init(BatteryController batteryController) {
        ...
        if (this.mRtxChargerManagerOptional.isPresent()) {
            this.mRtxChargerManagerOptional.get().addIsDockPresentChangeListener(new ReverseChargingController$$ExternalSyntheticLambda6(this));
            this.mRtxChargerManagerOptional.get().addReverseChargingInformationChangeListener(new ReverseChargingController$$ExternalSyntheticLambda8(this));
            this.mRtxChargerManagerOptional.get().addReverseChargingChangeListener(new ReverseChargingController$$ExternalSyntheticLambda7(this));
            try {
    ...
    public void lambda$onDockPresentChanged$7() {
        boolean z = DEBUG;
        if (z) {
    ...
    private void setReverseStateInternal(boolean z, int i) {
        if (isReverseSupported()) {
            ...
            if (z != isReverseOn()) {
                ...
                this.mBgExecutor.execute(new ReverseChargingController$$ExternalSyntheticLambda13(this, z));
            }
        }
    }
    ...
    public void onDockPresentChanged(Bundle bundle) {
        ...
        if (bundle.getByte("key_dock_present_type") == 4) {
            this.mBgExecutor.execute(new ReverseChargingController$$ExternalSyntheticLambda9(this));
            this.mMainExecutor.execute(new ReverseChargingController$$ExternalSyntheticLambda10(this, bundle));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: onDockPresentChangedOnMainThread */
    public void lambda$onDockPresentChanged$8(Bundle bundle) {
        if (DEBUG) {
    ...
    public void onReverseInformationChanged(Bundle bundle) {
        ...
        if (bundle.getInt("key_rtx_level") > 0) {
            this.mMainExecutor.execute(new ReverseChargingController$$ExternalSyntheticLambda12(this, bundle));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: onReverseInformationChangedOnMainThread */
    public void lambda$onReverseInformationChanged$9(Bundle bundle) {
        boolean z = false;
        if (DEBUG) {
            StringBuilder sb = new StringBuilder();
    ...
    public void onReverseStateChanged(Bundle bundle) {
        ...
        this.mMainExecutor.execute(new ReverseChargingController$$ExternalSyntheticLambda11(this, bundle));
    }

    /* access modifiers changed from: private */
    /* renamed from: onReverseStateChangedOnMainThread */
    public void lambda$onReverseStateChanged$10(Bundle bundle) {
        boolean z = DEBUG;
        int i = 0;
        if (z) {
            StringBuilder sb = new StringBuilder();
    ...
    /* access modifiers changed from: private */
    /* renamed from: setRtxMode */
    public void lambda$setReverseStateInternal$6(boolean z) {
        if (this.mRtxChargerManagerOptional.isPresent()) {
            if (DEBUG) {
