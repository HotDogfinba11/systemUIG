...
public class EntryPointController extends NavigationBarOverlayController implements NavigationModeController.ModeChangedListener {
    ...
    public EntryPointController(Context context, AccessibilityManager accessibilityManager, BroadcastDispatcher broadcastDispatcher, CommandQueue commandQueue, GameModeDndController gameModeDndController, Handler handler, NavigationModeController navigationModeController, OverviewProxyService overviewProxyService, PackageManager packageManager, ShortcutBarController shortcutBarController, ToastController toastController, GameDashboardUiEventLogger gameDashboardUiEventLogger, Optional<TaskSurfaceHelper> optional) {
        super(context);
        AnonymousClass1 r4 = new OverviewProxyService.OverviewProxyListener() {
            /* class com.google.android.systemui.gamedashboard.EntryPointController.AnonymousClass1 */
        ...
        this.mGameManager = (GameManager) this.mContext.getSystemService(GameManager.class);
        ...
        floatingEntryButton.setEntryPointOnClickListener(new EntryPointController$$ExternalSyntheticLambda0(this));
        ...
        AnonymousClass2 r2 = new CurrentUserTracker(broadcastDispatcher) {
            /* class com.google.android.systemui.gamedashboard.EntryPointController.AnonymousClass2 */
        ...
        checkAlwaysOn();
        AnonymousClass3 r22 = new ContentObserver(handler) {
            /* class com.google.android.systemui.gamedashboard.EntryPointController.AnonymousClass3 */
        ...
        shortcutBarController.setEntryPointOnTouchListener(new EntryPointController$$ExternalSyntheticLambda0(this));
        commandQueue.addCallback((CommandQueue.Callbacks) new CommandQueue.Callbacks() {
            /* class com.google.android.systemui.gamedashboard.EntryPointController.AnonymousClass4 */
    ...
    public void setButtonState(boolean z, boolean z2) {
        ...
        if (animator2 == null || !animator2.isRunning()) {
            ...
            ofFloat.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.systemui.gamedashboard.EntryPointController.AnonymousClass5 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onRunningTaskChange() {
        if (!this.mRecentsAnimationRunning) {
            ...
            if (runningTask != null && !ScreenRecordDialog.class.getName().equals(runningTask.baseActivity.getClassName())) {
                ...
                if (this.mShouldShow) {
                    ...
                    this.mTaskSurfaceHelper.ifPresent(new EntryPointController$$ExternalSyntheticLambda1(i, gameMode));
