...
public class ShortcutBarController {
    ...
    ShortcutBarController(Context context, WindowManager windowManager, FpsController fpsController, ConfigurationController configurationController, Handler handler, ScreenRecordController screenRecordController, Optional<TaskSurfaceHelper> optional, GameDashboardUiEventLogger gameDashboardUiEventLogger, ToastController toastController) {
    ...
    public void registerFps(int i) {
        ...
        fpsController.register(i, new ShortcutBarController$$ExternalSyntheticLambda0(shortcutBarView));
    }
