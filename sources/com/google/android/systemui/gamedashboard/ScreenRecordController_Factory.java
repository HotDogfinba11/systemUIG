...
public final class ScreenRecordController_Factory implements Factory<ScreenRecordController> {
    ...
    public static ScreenRecordController newInstance(RecordingController recordingController, Handler handler, KeyguardDismissUtil keyguardDismissUtil, UserContextProvider userContextProvider2, ToastController toastController) {
        return new ScreenRecordController(recordingController, handler, keyguardDismissUtil, userContextProvider2, toastController);
    }
}
