...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment implements Cloneable {
    ...
    public void getEdgePath(float f, float f2, float f3, ShapePath shapePath) {
        ...
        float f13 = f7 + f8;
        float f14 = f4 + f8;
        float sqrt = (float) Math.sqrt((double) ((f13 * f13) - (f14 * f14)));
        float f15 = f9 - sqrt;
        float f16 = f9 + sqrt;
        float degrees = (float) Math.toDegrees(Math.atan((double) (sqrt / f14)));
        ...
        if (z) {
            ...
            shapePath.addArc(f22 - (f20 + f24), -(f12 + f24), f22, f24 + f12, 90.0f, f17 - 0.049804688f);
        }
