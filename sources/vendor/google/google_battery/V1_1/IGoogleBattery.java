...
public interface IGoogleBattery extends vendor.google.google_battery.V1_0.IGoogleBattery {
    ...
    static default IGoogleBattery asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
    ...
    @Deprecated
    static default IGoogleBattery getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService("vendor.google.google_battery@1.1::IGoogleBattery", str));
    }

    @Deprecated
    static default IGoogleBattery getService() throws RemoteException {
