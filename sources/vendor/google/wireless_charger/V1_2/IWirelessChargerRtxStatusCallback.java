...
public interface IWirelessChargerRtxStatusCallback extends IHwInterface {
    ...
    public static abstract class Stub extends HwBinder implements IWirelessChargerRtxStatusCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList("vendor.google.wireless_charger@1.2::IWirelessChargerRtxStatusCallback", "android.hidl.base@1.0::IBase"));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{31, -61, -5, 52, -75, -23, 43, -97, -81, -10, -34, -35, 6, -29, -18, -126, 47, 34, 80, -50, 99, 33, 17, -14, -20, 25, -117, -52, -40, 93, -62, -120}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
