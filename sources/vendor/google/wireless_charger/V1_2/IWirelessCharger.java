...
public interface IWirelessCharger extends vendor.google.wireless_charger.V1_1.IWirelessCharger {
    ...
    @FunctionalInterface
    public interface getRtxInformationCallback {
        void onValues(byte b, RtxStatusInfo rtxStatusInfo);
    }

    void getRtxInformation(getRtxInformationCallback getrtxinformationcallback) throws RemoteException;
    ...
    static default IWirelessCharger asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
    ...
    @Deprecated
    static default IWirelessCharger getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService("vendor.google.wireless_charger@1.2::IWirelessCharger", str));
    }

    @Deprecated
    static default IWirelessCharger getService() throws RemoteException {
    ...
    public static final class Proxy implements IWirelessCharger {
        ...
        @Override // vendor.google.wireless_charger.V1_2.IWirelessCharger
        public void getRtxInformation(getRtxInformationCallback getrtxinformationcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("vendor.google.wireless_charger@1.2::IWirelessCharger");
            HwParcel hwParcel2 = new HwParcel();
            try {
