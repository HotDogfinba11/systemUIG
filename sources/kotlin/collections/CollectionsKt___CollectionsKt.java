...
public class CollectionsKt___CollectionsKt extends CollectionsKt___CollectionsJvmKt {
    ...
    public static <T> T elementAt(Iterable<? extends T> iterable, int i) {
        ...
        return iterable instanceof List ? (T) ((List) iterable).get(i) : (T) elementAtOrElse(iterable, i, new CollectionsKt___CollectionsKt$elementAt$1(i));
    }
    ...
    public static <T> List<T> takeLast(List<? extends T> list, int i) {
        ...
        if (!(i >= 0)) {
            ...
            if (i == 1) {
                return CollectionsKt__CollectionsJVMKt.listOf(CollectionsKt.last((List) list));
            }
            ArrayList arrayList = new ArrayList(i);
