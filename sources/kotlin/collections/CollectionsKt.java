...
public final class CollectionsKt extends CollectionsKt___CollectionsKt {
    public static /* bridge */ /* synthetic */ <T> T elementAt(Iterable<? extends T> iterable, int i) {
        return (T) CollectionsKt___CollectionsKt.elementAt(iterable, i);
    }

    public static /* bridge */ /* synthetic */ <T> T elementAtOrNull(Iterable<? extends T> iterable, int i) {
