...
public enum PixelAtoms$DoubleTapNanoappEventReported$Type implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<PixelAtoms$DoubleTapNanoappEventReported$Type> internalValueMap = new Internal.EnumLiteMap<PixelAtoms$DoubleTapNanoappEventReported$Type>() {
        /* class android.hardware.google.pixel.vendor.PixelAtoms$DoubleTapNanoappEventReported$Type.AnonymousClass1 */
    ...
    private PixelAtoms$DoubleTapNanoappEventReported$Type(int i) {
        this.value = i;
    }
