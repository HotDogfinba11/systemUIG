...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            switch (c3) {
                case 'A':
                case R$styleable.Constraint_layout_editor_absoluteY:
                    i3 = 7;
                    i = i3;
                    break;
                case 'C':
                ...
                case 'M':
                case 'T':
                case R$styleable.Constraint_transitionEasing:
                case R$styleable.Constraint_transitionPathRotate:
                case androidx.appcompat.R$styleable.AppCompatTheme_viewInflaterClass:
                default:
                    i = 2;
                    break;
                case 'Q':
                ...
                case androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMajor:
                    path.close();
                    path.moveTo(f13, f14);
                    f9 = f13;
                    f11 = f9;
