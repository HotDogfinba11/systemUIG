...
public final class MediaRouter {
    ...
    public static final class GlobalMediaRouter implements SystemMediaRouteProvider.SyncCallback, RegisteredMediaRouteProviderWatcher.Callback {
        private MediaRouterActiveScanThrottlingHelper mActiveScanThrottlingHelper = new MediaRouterActiveScanThrottlingHelper(new Runnable() {
            /* class androidx.mediarouter.media.MediaRouter.GlobalMediaRouter.AnonymousClass1 */
        ...
        MediaRouteProvider.DynamicGroupRouteController.OnDynamicRoutesChangedListener mDynamicRoutesListener = new MediaRouteProvider.DynamicGroupRouteController.OnDynamicRoutesChangedListener() {
            /* class androidx.mediarouter.media.MediaRouter.GlobalMediaRouter.AnonymousClass3 */
        ...
        public final class CallbackHandler extends Handler {
            ...
            private void syncWithSystemProvider(int i, Object obj) {
                if (i == 262) {
                    S s = ((Pair) obj).second;
                    GlobalMediaRouter.this.mSystemProvider.onSyncRouteSelected(s);
                    if (GlobalMediaRouter.this.mDefaultRoute != null && s.isDefaultOrBluetooth()) {
                        for (RouteInfo routeInfo : this.mDynamicGroupRoutes) {
                            GlobalMediaRouter.this.mSystemProvider.onSyncRouteRemoved(routeInfo);
                        }
                    ...
                    S s2 = ((Pair) obj).second;
                    this.mDynamicGroupRoutes.add(s2);
                    GlobalMediaRouter.this.mSystemProvider.onSyncRouteAdded(s2);
                    GlobalMediaRouter.this.mSystemProvider.onSyncRouteSelected(s2);
                }
            }
            ...
            private void invokeCallback(CallbackRecord callbackRecord, int i, Object obj, int i2) {
                ...
                int i3 = 65280 & i;
                if (i3 == 256) {
                    S s = (i == 264 || i == 262) ? ((Pair) obj).second : (RouteInfo) obj;
                    if (i == 264 || i == 262) {
                        f = ((Pair) obj).first;
                    } else {
                        f = null;
                    }
                    if (s != null && callbackRecord.filterRouteEvent(s, i, f, i2)) {
                        switch (i) {
                            case 257:
                                callback.onRouteAdded(mediaRouter, s);
                                return;
                            case 258:
                                callback.onRouteRemoved(mediaRouter, s);
                                return;
                            case 259:
                                callback.onRouteChanged(mediaRouter, s);
                                return;
                            case 260:
                                callback.onRouteVolumeChanged(mediaRouter, s);
                                return;
                            case 261:
                                callback.onRoutePresentationDisplayChanged(mediaRouter, s);
                                return;
                            case 262:
                                callback.onRouteSelected(mediaRouter, s, i2, s);
                                return;
                            case 263:
                                callback.onRouteUnselected(mediaRouter, s, i2);
                                return;
                            case 264:
                                callback.onRouteSelected(mediaRouter, s, i2, f);
                                return;
                            default:
                                return;
                        }
